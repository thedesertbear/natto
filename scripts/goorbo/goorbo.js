...
function AftercoreQuest() {
  return {
    ...
    tasks: [{
      ...
      name: "Harvest Garden",
      completed: () => getGarden() === template_string_$item(aftercore_templateObject2 || (aftercore_templateObject2 = aftercore_taggedTemplateLiteral(["none"]))) || (0,external_kolmafia_namespaceObject.getCampground)()[getGarden().name] === 0,
      ...
      name: "Plant Grass",
      completed: () => !lib_have(template_string_$item(aftercore_templateObject3 || (aftercore_templateObject3 = aftercore_taggedTemplateLiteral(["packet of tall grass seeds"])))) || getGarden() === template_string_$item(aftercore_templateObject4 || (aftercore_templateObject4 = aftercore_taggedTemplateLiteral(["packet of tall grass seeds"]))),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercore_templateObject5 || (aftercore_templateObject5 = aftercore_taggedTemplateLiteral(["packet of tall grass seeds"])))),
      tracking: "Dailies"
    }, {
      name: "Drive Observantly",
      completed: () => property_get("dailyDungeonDone") || (0,external_kolmafia_namespaceObject.getWorkshed)() !== template_string_$item(aftercore_templateObject6 || (aftercore_templateObject6 = aftercore_taggedTemplateLiteral(["Asdon Martin keyfob"]))) || (0,external_kolmafia_namespaceObject.haveEffect)($effect(aftercore_templateObject7 || (aftercore_templateObject7 = aftercore_taggedTemplateLiteral(["Driving Observantly"])))) >= 800,
      do: () => drive($effect(aftercore_templateObject8 || (aftercore_templateObject8 = aftercore_taggedTemplateLiteral(["Driving Observantly"]))), 810, false)
    }, {
      name: "Sample Constellation DNA",
      ready: () => lib_have(template_string_$item(aftercore_templateObject9 || (aftercore_templateObject9 = aftercore_taggedTemplateLiteral(["DNA extraction syringe"])))),
      completed: () => !DNALab_installed() || isHybridized($phylum(aftercore_templateObject10 || (aftercore_templateObject10 = aftercore_taggedTemplateLiteral(["Constellation"])))) || property_get("dnaSyringe") === $phylum(aftercore_templateObject11 || (aftercore_templateObject11 = aftercore_taggedTemplateLiteral(["Constellation"]))),
      outfit: {
        familiar: bestFam(),
        modifier: "".concat(maxBase())
      },
      do: $location(aftercore_templateObject12 || (aftercore_templateObject12 = aftercore_taggedTemplateLiteral(["The Hole in the Sky"]))),
      combat: new CombatStrategy().macro(Macro.skill($skill(aftercore_templateObject13 || (aftercore_templateObject13 = aftercore_taggedTemplateLiteral(["Infinite Loop"])))), getTodaysHolidayWanderers()).macro(Macro.tryItem(template_string_$item(aftercore_templateObject14 || (aftercore_templateObject14 = aftercore_taggedTemplateLiteral(["DNA extraction syringe"]))))).macro(Macro.tryItem(template_string_$item(aftercore_templateObject15 || (aftercore_templateObject15 = aftercore_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(aftercore_templateObject16 || (aftercore_templateObject16 = aftercore_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
    }, {
      name: "Hybridize Constellation",
      ready: () => property_get("dnaSyringe") === $phylum(aftercore_templateObject17 || (aftercore_templateObject17 = aftercore_taggedTemplateLiteral(["Constellation"]))),
      completed: () => !DNALab_installed() || isHybridized($phylum(aftercore_templateObject18 || (aftercore_templateObject18 = aftercore_taggedTemplateLiteral(["Constellation"])))),
      do: () => {
        hybridize();
        makeTonic(3);
      }
      ...
      name: "Install CMC",
      completed: () => (0,external_kolmafia_namespaceObject.getWorkshed)() === template_string_$item(aftercore_templateObject19 || (aftercore_templateObject19 = aftercore_taggedTemplateLiteral(["cold medicine cabinet"]))) || !lib_have(template_string_$item(aftercore_templateObject20 || (aftercore_templateObject20 = aftercore_taggedTemplateLiteral(["cold medicine cabinet"])))) || property_get("_workshedItemUsed"),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercore_templateObject21 || (aftercore_templateObject21 = aftercore_taggedTemplateLiteral(["cold medicine cabinet"]))))
    }, {
      name: "LGR Seed",
      ...
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("".concat(args.garboascend)),
      post: () => $effects(aftercore_templateObject75 || (aftercore_templateObject75 = aftercore_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef)),
      tracking: "Garbo"
    }, {
      name: "Stooper",
      ready: () => (0,external_kolmafia_namespaceObject.myInebriety)() === (0,external_kolmafia_namespaceObject.inebrietyLimit)() && lib_have(template_string_$item(aftercore_templateObject76 || (aftercore_templateObject76 = aftercore_taggedTemplateLiteral(["tiny stillsuit"])))) && property_get("familiarSweat") >= 300,
      completed: () => !lib_have(template_string_$familiar(aftercore_templateObject77 || (aftercore_templateObject77 = aftercore_taggedTemplateLiteral(["Stooper"])))) || stooperDrunk(),
      do: () => {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(aftercore_templateObject78 || (aftercore_templateObject78 = aftercore_taggedTemplateLiteral(["Stooper"]))));
        (0,external_kolmafia_namespaceObject.cliExecute)("drink stillsuit distillate");
      }
    }, {
      name: "Nightcap",
      ready: () => lib_have(template_string_$item(aftercore_templateObject79 || (aftercore_templateObject79 = aftercore_taggedTemplateLiteral(["Drunkula's wineglass"])))),
      ...
      prepare: () => uneffect($effect(aftercore_templateObject81 || (aftercore_templateObject81 = aftercore_taggedTemplateLiteral(["Beaten Up"])))),
      ...
      post: () => $effects(aftercore_templateObject82 || (aftercore_templateObject82 = aftercore_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef)),
      tracking: "Garbo"
    }, {
      name: "Turn in FunFunds",
      ready: () => property_get("_stenchAirportToday") && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(aftercore_templateObject83 || (aftercore_templateObject83 = aftercore_taggedTemplateLiteral(["FunFunds\u2122"])))) >= 20,
      completed: () => lib_have(template_string_$item(aftercore_templateObject84 || (aftercore_templateObject84 = aftercore_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      do: () => (0,external_kolmafia_namespaceObject.buy)($coinmaster(aftercore_templateObject85 || (aftercore_templateObject85 = aftercore_taggedTemplateLiteral(["The Dinsey Company Store"]))), 1, template_string_$item(_templateObject86 || (_templateObject86 = aftercore_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      tracking: "Garbo"
    }, {
      name: "PvP",
      ...
      completed: () => !lib_have($skill(_templateObject87 || (_templateObject87 = aftercore_taggedTemplateLiteral(["That's Not a Knife"])))) || property_get("_discoKnife"),
      prepare: () => (0,external_kolmafia_namespaceObject.putCloset)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject88 || (_templateObject88 = aftercore_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject89 || (_templateObject89 = aftercore_taggedTemplateLiteral(["soap knife"])))),
      do: () => (0,external_kolmafia_namespaceObject.useSkill)($skill(_templateObject90 || (_templateObject90 = aftercore_taggedTemplateLiteral(["That's Not a Knife"])))),
      post: () => (0,external_kolmafia_namespaceObject.takeCloset)((0,external_kolmafia_namespaceObject.closetAmount)(template_string_$item(_templateObject91 || (_templateObject91 = aftercore_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject92 || (_templateObject92 = aftercore_taggedTemplateLiteral(["soap knife"]))))
    }, {
      ...
      do: () => {
        ...
        var nPerms = targetPerms(true);
        var moonsign = toMoonSign(lib_have(template_string_$item(_templateObject93 || (_templateObject93 = aftercore_taggedTemplateLiteral(["hewn moon-rune spoon"])))) || !$skills(_templateObject94 || (_templateObject94 = aftercore_taggedTemplateLiteral(["Torso Awareness, Gnefarious Pickpocketing, Powers of Observatiogn, Gnomish Hardigness, Cosmic Ugnderstanding"]))).find(sk => !(sk.name in (0,external_kolmafia_namespaceObject.getPermedSkills)()) //skip checking gnomes if you have a moon spoon or have all gnome skills permed
        ) ? args.moonsign : nPerms.includes($skill(_templateObject95 || (_templateObject95 = aftercore_taggedTemplateLiteral(["Torso Awareness"])))) || !$skills(_templateObject96 || (_templateObject96 = aftercore_taggedTemplateLiteral(["Gnefarious Pickpocketing, Powers of Observatiogn, Gnomish Hardigness, Cosmic Ugnderstanding"]))).find(sk => !nPerms.includes(sk) //plan to perm Torso Awareness or all 4 other gnome skills
        ) ? "wombat" : args.moonsign);
        ascend($path(_templateObject97 || (_templateObject97 = aftercore_taggedTemplateLiteral(["Grey You"]))), $class(_templateObject98 || (_templateObject98 = aftercore_taggedTemplateLiteral(["Grey Goo"]))), Lifestyle.softcore, moonsign, template_string_$item(_templateObject99 || (_templateObject99 = aftercore_taggedTemplateLiteral(["astral six-pack"]))), args.astralpet === template_string_$item(_templateObject100 || (_templateObject100 = aftercore_taggedTemplateLiteral(["none"]))) ? undefined : args.astralpet, {
...
function GyouQuest() {
  return {
    ...
    tasks: [{
      ...
      acquire: [{
        item: template_string_$item(_templateObject101 || (_templateObject101 = greyyou_taggedTemplateLiteral(["box of Familiar Jacks"]))),
        price: 20000
      }],
      do: () => {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject102 || (_templateObject102 = greyyou_taggedTemplateLiteral(["Cornbeefadon"]))));
        (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject103 || (_templateObject103 = greyyou_taggedTemplateLiteral(["box of Familiar Jacks"]))));
      }
    }, {
      name: "Tower",
      ...
      combat: new CombatStrategy().macro(() => {
        ...
        return (_Macro$tryItem$trySki = Macro.tryItem(template_string_$item(_templateObject269 || (_templateObject269 = greyyou_taggedTemplateLiteral(["gas balloon"])))).trySkill($skill(_templateObject270 || (_templateObject270 = greyyou_taggedTemplateLiteral(["Feel Pride"]))))).tryItem.apply(_Macro$tryItem$trySki, greyyou_toConsumableArray(template_string_$items(_templateObject271 || (_templateObject271 = greyyou_taggedTemplateLiteral(["shard of double-ice, gas can"]))))).attack().repeat();
      }),
      tracking: "Leveling"
    }, {
      name: "Drunk Pygmies",
      ready: () => !!$effects(_templateObject272 || (_templateObject272 = greyyou_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).find(ef => lib_have(ef)),
      completed: () => (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel || property_get("_drunkPygmyBanishes") >= 11 && !property_get("crystalBallPredictions").includes($monster(_templateObject273 || (_templateObject273 = greyyou_taggedTemplateLiteral(["drunk pygmy"]))).name),
      acquire: [{
        item: template_string_$item(_templateObject274 || (_templateObject274 = greyyou_taggedTemplateLiteral(["Bowl of Scorpions"]))),
        price: 1000
      }].concat(greyyou_toConsumableArray($monsters(_templateObject275 || (_templateObject275 = greyyou_taggedTemplateLiteral(["pygmy orderlies, pygmy bowler"]))).find(mob => !(0,external_kolmafia_namespaceObject.isBanished)(mob)) ? [{
        item: nextUnusedBanishItem(),
        price: 20000
      }] : [])),
      effects: $effects(_templateObject276 || (_templateObject276 = greyyou_taggedTemplateLiteral(["Heart of White"]))),
      outfit: () => greyyou_objectSpread(greyyou_objectSpread(greyyou_objectSpread(greyyou_objectSpread({
        familiar: template_string_$familiar(_templateObject277 || (_templateObject277 = greyyou_taggedTemplateLiteral(["Grey Goose"])))
      }, lib_have(template_string_$item(_templateObject278 || (_templateObject278 = greyyou_taggedTemplateLiteral(["cursed magnifying glass"])))) && template_string_$familiar(_templateObject279 || (_templateObject279 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience < 400 ? {
        offhand: template_string_$item(_templateObject280 || (_templateObject280 = greyyou_taggedTemplateLiteral(["cursed magnifying glass"])))
      } : {}), lib_have(template_string_$item(_templateObject281 || (_templateObject281 = greyyou_taggedTemplateLiteral(["miniature crystal ball"])))) && property_get("_drunkPygmyBanishes") >= 10 ? {
        famequip: template_string_$item(_templateObject282 || (_templateObject282 = greyyou_taggedTemplateLiteral(["miniature crystal ball"])))
      } : {}), lib_have(template_string_$item(_templateObject283 || (_templateObject283 = greyyou_taggedTemplateLiteral(["mafia middle finger ring"])))) && (0,external_kolmafia_namespaceObject.myBasestat)($stat(_templateObject284 || (_templateObject284 = greyyou_taggedTemplateLiteral(["Muscle"])))) >= 45 && !property_get("_mafiaMiddleFingerRingUsed") ? {
        equip: [template_string_$item(_templateObject285 || (_templateObject285 = greyyou_taggedTemplateLiteral(["mafia middle finger ring"])))]
      } : {}), {}, {
      ...
      prepare: () => {
        ...
        if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject286 || (_templateObject286 = greyyou_taggedTemplateLiteral(["bowling ball"])))) > 0) (0,external_kolmafia_namespaceObject.putCloset)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject287 || (_templateObject287 = greyyou_taggedTemplateLiteral(["bowling ball"])))), template_string_$item(_templateObject288 || (_templateObject288 = greyyou_taggedTemplateLiteral(["bowling ball"]))));
      },
      do: $location(_templateObject289 || (_templateObject289 = greyyou_taggedTemplateLiteral(["The Hidden Bowling Alley"]))),
      combat: new CombatStrategy().macro(() => Macro.externalIf(template_string_$familiar(_templateObject290 || (_templateObject290 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject291 || (_templateObject291 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject292 || (_templateObject292 = greyyou_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject293 || (_templateObject293 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject294 || (_templateObject294 = greyyou_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject295 || (_templateObject295 = greyyou_taggedTemplateLiteral(["Convert Matter to Pomade"]))))), $monsters(_templateObject296 || (_templateObject296 = greyyou_taggedTemplateLiteral(["void slab, void guy, void spider, drunk pygmy"])))).macro(() => Macro.trySkill($skill(_templateObject297 || (_templateObject297 = greyyou_taggedTemplateLiteral(["Show them your ring"])))).externalIf(lib_have($skill(_templateObject298 || (_templateObject298 = greyyou_taggedTemplateLiteral(["Snokebomb"])))) && !getBanishedMonsters().get($skill(_templateObject299 || (_templateObject299 = greyyou_taggedTemplateLiteral(["Snokebomb"])))), Macro.trySkill($skill(_templateObject300 || (_templateObject300 = greyyou_taggedTemplateLiteral(["Snokebomb"]))))).externalIf(lib_have($skill(_templateObject301 || (_templateObject301 = greyyou_taggedTemplateLiteral(["Feel Hatred"])))) && !getBanishedMonsters().get($skill(_templateObject302 || (_templateObject302 = greyyou_taggedTemplateLiteral(["Feel Hatred"])))), Macro.trySkill($skill(_templateObject303 || (_templateObject303 = greyyou_taggedTemplateLiteral(["Feel Hatred"]))))).tryItem(nextUnusedBanishItem()), $monsters(_templateObject304 || (_templateObject304 = greyyou_taggedTemplateLiteral(["pygmy bowler, pygmy orderlies, pygmy janitor"])))).macro(Macro.tryItem(template_string_$item(_templateObject305 || (_templateObject305 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).tryItem(template_string_$item(_templateObject306 || (_templateObject306 = greyyou_taggedTemplateLiteral(["spectre scepter"])))).attack().repeat()),
      limit: {
        tries: 15
      },
      tracking: "Leveling"
      ...
      name: "Ball Pit",
      completed: () => !lib_have(template_string_$item(_templateObject307 || (_templateObject307 = greyyou_taggedTemplateLiteral(["Clan VIP Lounge key"])))) || property_get("_ballpit"),
      ...
      name: "Telescope Buff",
      completed: () => !(template_string_$item(_templateObject308 || (_templateObject308 = greyyou_taggedTemplateLiteral(["Discount Telescope Warehouse gift certificate"]))).name in (0,external_kolmafia_namespaceObject.getCampground)()) || property_get("telescopeLookedHigh"),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("telescope high"),
      tracking: "Leveling"
    }, {
      name: "Fight Seals",
      ready: () => lib_have(template_string_$item(_templateObject309 || (_templateObject309 = greyyou_taggedTemplateLiteral(["figurine of a wretched-looking seal"])))) && lib_have(template_string_$item(_templateObject310 || (_templateObject310 = greyyou_taggedTemplateLiteral(["seal-blubber candle"])))),
      completed: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject311 || (_templateObject311 = greyyou_taggedTemplateLiteral(["Seal Clubber"]))) || property_get("_sealsSummoned") >= 10 || !lib_have(template_string_$item(_templateObject312 || (_templateObject312 = greyyou_taggedTemplateLiteral(["Claw of the Infernal Seal"])))) && property_get("_sealsSummoned") >= 5,
      outfit: () => ({
      ...
      combat: new CombatStrategy().macro(() => Macro.externalIf(template_string_$familiar(_templateObject314 || (_templateObject314 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject315 || (_templateObject315 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject316 || (_templateObject316 = greyyou_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject317 || (_templateObject317 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject318 || (_templateObject318 = greyyou_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject319 || (_templateObject319 = greyyou_taggedTemplateLiteral(["Convert Matter to Pomade"]))))).trySkill($skill(_templateObject320 || (_templateObject320 = greyyou_taggedTemplateLiteral(["Sing Along"])))).tryItem(template_string_$item(_templateObject321 || (_templateObject321 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).attack().repeat()),
      limit: {
        tries: 10
      },
      tracking: "Leveling"
      ...
      outfit: () => ({
        familiar: template_string_$familiar(_templateObject322 || (_templateObject322 = greyyou_taggedTemplateLiteral(["Grey Goose"]))),
      ...
      effects: $effects(_templateObject334 || (_templateObject334 = greyyou_taggedTemplateLiteral(["Trivia Master"]))),
      ...
      acquire: () => greyyou_toConsumableArray(lib_have($skill(_templateObject335 || (_templateObject335 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))) ? [] : [{
        item: template_string_$item(_templateObject336 || (_templateObject336 = greyyou_taggedTemplateLiteral(["electronics kit"]))),
        price: 500
      }]),
      outfit: () => ({
        familiar: template_string_$familiar(_templateObject337 || (_templateObject337 = greyyou_taggedTemplateLiteral(["Grey Goose"]))),
      ...
      combat: new CombatStrategy().macro(() => Macro.externalIf(lib_have($skill(_templateObject338 || (_templateObject338 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill($skill(_templateObject339 || (_templateObject339 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(_templateObject340 || (_templateObject340 = greyyou_taggedTemplateLiteral(["electronics kit"]))))).externalIf(template_string_$familiar(_templateObject341 || (_templateObject341 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject342 || (_templateObject342 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject343 || (_templateObject343 = greyyou_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject344 || (_templateObject344 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject345 || (_templateObject345 = greyyou_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject346 || (_templateObject346 = greyyou_taggedTemplateLiteral(["Convert Matter to Pomade"]))))).tryItem(template_string_$item(_templateObject347 || (_templateObject347 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(_templateObject348 || (_templateObject348 = greyyou_taggedTemplateLiteral(["Sing Along"])))).attack().repeat()),
      tracking: "Leveling"
    }, {
      name: "NEP Free Fights",
      ready: () => property_get("neverendingPartyAlways") && !!$effects(_templateObject349 || (_templateObject349 = greyyou_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).find(ef => lib_have(ef)),
      completed: () => property_get("_neverendingPartyFreeTurns") >= 10 || (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject350 || (_templateObject350 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel,
      effects: $effects(_templateObject351 || (_templateObject351 = greyyou_taggedTemplateLiteral(["Heart of White"]))),
      ...
      }, lib_have(template_string_$item(_templateObject357 || (_templateObject357 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))) ? {
        shirt: template_string_$item(_templateObject358 || (_templateObject358 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))
      } : {}), {}, {
        modifier: "0.125 ".concat((0,external_kolmafia_namespaceObject.myPrimestat)(), ", ").concat((0,external_kolmafia_namespaceObject.myPrimestat)(), " experience, 5 ").concat((0,external_kolmafia_namespaceObject.myPrimestat)(), " experience percent, 10 familiar experience, ").concat(noML())
      }),
      prepare: () => {
      ...
      do: $location(_templateObject359 || (_templateObject359 = greyyou_taggedTemplateLiteral(["The Neverending Party"]))),
      post: () => {
        if (!property_get("_lastCombatWon")) throw new Error("Lost Combat - Check to see what went wrong.");
      },
      choices: {
      ...
      combat: new CombatStrategy().macro(() => {
        ...
        return (_Macro$step$externalI = Macro.step("pickpocket").externalIf(lib_have($skill(_templateObject360 || (_templateObject360 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill($skill(_templateObject361 || (_templateObject361 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(_templateObject362 || (_templateObject362 = greyyou_taggedTemplateLiteral(["electronics kit"]))))).trySkill($skill(_templateObject363 || (_templateObject363 = greyyou_taggedTemplateLiteral(["Bowl Sideways"])))).externalIf(template_string_$familiar(_templateObject364 || (_templateObject364 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject365 || (_templateObject365 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject366 || (_templateObject366 = greyyou_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject367 || (_templateObject367 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject368 || (_templateObject368 = greyyou_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject369 || (_templateObject369 = greyyou_taggedTemplateLiteral(["Convert Matter to Pomade"])))))).tryItem.apply(_Macro$step$externalI, greyyou_toConsumableArray(template_string_$items(_templateObject370 || (_templateObject370 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun, HOA citation pad"]))))).trySkill($skill(_templateObject371 || (_templateObject371 = greyyou_taggedTemplateLiteral(["Sing Along"])))).externalIf((0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel - 2, Macro.trySkill($skill(_templateObject372 || (_templateObject372 = greyyou_taggedTemplateLiteral(["Feel Pride"]))))).attack().repeat();
      }),
      limit: {
        tries: 13
      },
      ...
      name: "God Lobster",
      ready: () => (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel - 1 && !!$effects(_templateObject373 || (_templateObject373 = greyyou_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).find(ef => lib_have(ef)),
      completed: () => property_get("_godLobsterFights") >= 3 || (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject374 || (_templateObject374 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel,
      effects: $effects(_templateObject375 || (_templateObject375 = greyyou_taggedTemplateLiteral(["Heart of White"]))),
      acquire: () => [].concat(greyyou_toConsumableArray(lib_have($skill(_templateObject376 || (_templateObject376 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))) ? [] : [{
        item: template_string_$item(_templateObject377 || (_templateObject377 = greyyou_taggedTemplateLiteral(["electronics kit"]))),
        price: 500
      }]), greyyou_toConsumableArray(lib_have(template_string_$familiar(_templateObject378 || (_templateObject378 = greyyou_taggedTemplateLiteral(["God Lobster"])))) ? [] : [{
        item: template_string_$item(_templateObject379 || (_templateObject379 = greyyou_taggedTemplateLiteral(["Dish of Clarified Butter"]))),
        price: property_get("valueOfAdventure") / 2
      }]), greyyou_toConsumableArray(lib_have(template_string_$item(_templateObject380 || (_templateObject380 = greyyou_taggedTemplateLiteral(["January's Garbage Tote"])))) ? [{
        item: template_string_$item(_templateObject381 || (_templateObject381 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))
      }] : [])),
      outfit: () => greyyou_objectSpread(greyyou_objectSpread({}, lib_have(template_string_$item(_templateObject382 || (_templateObject382 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))) ? {
        shirt: template_string_$item(_templateObject383 || (_templateObject383 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))
      } : {}), {}, {
      ...
      do: () => {
        if (lib_have(template_string_$familiar(_templateObject384 || (_templateObject384 = greyyou_taggedTemplateLiteral(["God Lobster"]))))) (0,external_kolmafia_namespaceObject.visitUrl)("main.php?fightgodlobster=1");else (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject385 || (_templateObject385 = greyyou_taggedTemplateLiteral(["Dish of Clarified Butter"]))));
        (0,external_kolmafia_namespaceObject.runCombat)();
      ...
      combat: new CombatStrategy().macro(() => Macro.step("pickpocket").externalIf(lib_have($skill(_templateObject386 || (_templateObject386 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill($skill(_templateObject387 || (_templateObject387 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(_templateObject388 || (_templateObject388 = greyyou_taggedTemplateLiteral(["electronics kit"]))))).tryItem(template_string_$item(_templateObject389 || (_templateObject389 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(_templateObject390 || (_templateObject390 = greyyou_taggedTemplateLiteral(["Sing Along"])))).trySkill($skill(_templateObject391 || (_templateObject391 = greyyou_taggedTemplateLiteral(["Feel Pride"])))).attack().repeat()),
      limit: {
        tries: 3
      },
      tracking: "Leveling"
      ...
      name: "Gators",
      ready: () => !!$effects(_templateObject392 || (_templateObject392 = greyyou_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).find(ef => lib_have(ef)),
      completed: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject393 || (_templateObject393 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel,
      effects: $effects(_templateObject394 || (_templateObject394 = greyyou_taggedTemplateLiteral(["Heart of White, Expert Vacationer"]))),
      acquire: () => [].concat(greyyou_toConsumableArray(lib_have($skill(_templateObject395 || (_templateObject395 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))) ? [] : [{
        item: template_string_$item(_templateObject396 || (_templateObject396 = greyyou_taggedTemplateLiteral(["electronics kit"]))),
        price: 500
      }]), greyyou_toConsumableArray(lib_have(template_string_$item(_templateObject397 || (_templateObject397 = greyyou_taggedTemplateLiteral(["January's Garbage Tote"])))) ? [{
        item: template_string_$item(_templateObject398 || (_templateObject398 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))
      }] : [])),
      outfit: () => greyyou_objectSpread(greyyou_objectSpread(greyyou_objectSpread({
        familiar: template_string_$familiar(_templateObject399 || (_templateObject399 = greyyou_taggedTemplateLiteral(["Grey Goose"])))
      }, lib_have(template_string_$item(_templateObject400 || (_templateObject400 = greyyou_taggedTemplateLiteral(["The Jokester's gun"])))) && (0,external_kolmafia_namespaceObject.myBasestat)($stat(_templateObject401 || (_templateObject401 = greyyou_taggedTemplateLiteral(["Moxie"])))) >= 50 && !property_get("_firedJokestersGun") ? {
        weapon: template_string_$item(_templateObject402 || (_templateObject402 = greyyou_taggedTemplateLiteral(["The Jokester's gun"])))
      } : lib_have(template_string_$item(_templateObject403 || (_templateObject403 = greyyou_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) && property_get("_chestXRayUsed") < 3 ? {
        equip: [template_string_$item(_templateObject404 || (_templateObject404 = greyyou_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))]
      } : {}), lib_have(template_string_$item(_templateObject405 || (_templateObject405 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))) ? {
        shirt: template_string_$item(_templateObject406 || (_templateObject406 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))
      } : {}), {}, {
        modifier: "0.125 ".concat((0,external_kolmafia_namespaceObject.myPrimestat)(), ", ").concat((0,external_kolmafia_namespaceObject.myPrimestat)(), " experience, 5 ").concat((0,external_kolmafia_namespaceObject.myPrimestat)(), " experience percent, 10 familiar experience, ").concat(noML())
      }),
      prepare: () => {
      ...
      do: $location(_templateObject407 || (_templateObject407 = greyyou_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))),
      post: () => {
        if (!property_get("_lastCombatWon")) throw new Error("Lost Combat - Check to see what went wrong.");
      },
      combat: new CombatStrategy().macro(() => Macro.step("pickpocket").externalIf(lib_have($skill(_templateObject408 || (_templateObject408 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill($skill(_templateObject409 || (_templateObject409 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(_templateObject410 || (_templateObject410 = greyyou_taggedTemplateLiteral(["electronics kit"]))))).trySkill($skill(_templateObject411 || (_templateObject411 = greyyou_taggedTemplateLiteral(["Bowl Sideways"])))).externalIf(template_string_$familiar(_templateObject412 || (_templateObject412 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject413 || (_templateObject413 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject414 || (_templateObject414 = greyyou_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject415 || (_templateObject415 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject416 || (_templateObject416 = greyyou_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject417 || (_templateObject417 = greyyou_taggedTemplateLiteral(["Convert Matter to Pomade"]))))).tryItem(template_string_$item(_templateObject418 || (_templateObject418 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(_templateObject419 || (_templateObject419 = greyyou_taggedTemplateLiteral(["Sing Along"])))).externalIf((0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel - 2, Macro.trySkill($skill(_templateObject420 || (_templateObject420 = greyyou_taggedTemplateLiteral(["Feel Pride"]))))).trySkill($skill(_templateObject421 || (_templateObject421 = greyyou_taggedTemplateLiteral(["Fire the Jokester's Gun"])))).trySkill($skill(_templateObject422 || (_templateObject422 = greyyou_taggedTemplateLiteral(["Chest X-Ray"])))).trySkill($skill(_templateObject423 || (_templateObject423 = greyyou_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill($skill(_templateObject424 || (_templateObject424 = greyyou_taggedTemplateLiteral(["Shattering Punch"])))).attack().repeat()),
      limit: {
      ...
      completed: () => !lib_have($skill(_templateObject425 || (_templateObject425 = greyyou_taggedTemplateLiteral(["Comprehensive Cartography"])))) || (0,external_kolmafia_namespaceObject.myAscensions)() === property_get("lastCartographyBooPeak"),
      choices: {
        1430: 3,
        606: 4,
        610: 1,
      ...
      do: $location(_templateObject426 || (_templateObject426 = greyyou_taggedTemplateLiteral(["A-Boo Peak"]))),
      outfit: {
      ...
      prepare: () => uneffect($effect(_templateObject427 || (_templateObject427 = greyyou_taggedTemplateLiteral(["Beaten Up"])))),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)(args.garbo),
      post: () => $effects(_templateObject428 || (_templateObject428 = greyyou_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef)),
      tracking: "Garbo"
    }, {
      name: "Turn in FunFunds",
      ready: () => property_get("_stenchAirportToday") && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject429 || (_templateObject429 = greyyou_taggedTemplateLiteral(["FunFunds\u2122"])))) >= 20,
      completed: () => lib_have(template_string_$item(_templateObject430 || (_templateObject430 = greyyou_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      do: () => (0,external_kolmafia_namespaceObject.buy)($coinmaster(_templateObject431 || (_templateObject431 = greyyou_taggedTemplateLiteral(["The Dinsey Company Store"]))), 1, template_string_$item(_templateObject432 || (_templateObject432 = greyyou_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      tracking: "Garbo"
    }, {
      name: "PvP",
      ...
      name: "Stooper",
      ready: () => (0,external_kolmafia_namespaceObject.myInebriety)() === (0,external_kolmafia_namespaceObject.inebrietyLimit)() && lib_have(template_string_$item(_templateObject433 || (_templateObject433 = greyyou_taggedTemplateLiteral(["tiny stillsuit"])))) && property_get("familiarSweat") >= 300,
      completed: () => !lib_have(template_string_$familiar(_templateObject434 || (_templateObject434 = greyyou_taggedTemplateLiteral(["Stooper"])))) || stooperDrunk(),
      do: () => {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject435 || (_templateObject435 = greyyou_taggedTemplateLiteral(["Stooper"]))));
        (0,external_kolmafia_namespaceObject.cliExecute)("drink stillsuit distillate");
      }
    }, {
      name: "Nightcap",
      ...
      name: "Plant Garden",
      ready: () => doneAdventuring() && !!template_string_$items(_templateObject436 || (_templateObject436 = greyyou_taggedTemplateLiteral(["packet of thanksgarden seeds, Peppermint Pip Packet, packet of winter seeds, packet of beer seeds, packet of pumpkin seeds, packet of dragon's teeth"]))).find(it => lib_have(it)),
      completed: () => getGarden() !== template_string_$item(_templateObject437 || (_templateObject437 = greyyou_taggedTemplateLiteral(["packet of tall grass seeds"]))),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$items(_templateObject438 || (_templateObject438 = greyyou_taggedTemplateLiteral(["packet of thanksgarden seeds, Peppermint Pip Packet, packet of winter seeds, packet of beer seeds, packet of pumpkin seeds, packet of dragon's teeth"]))).find(it => lib_have(it)) || template_string_$item(_templateObject439 || (_templateObject439 = greyyou_taggedTemplateLiteral(["none"]))))
    }, {
      name: "Pajamas",
      completed: () => (0,external_kolmafia_namespaceObject.getCampground)()[template_string_$item(_templateObject440 || (_templateObject440 = greyyou_taggedTemplateLiteral(["clockwork maid"]))).name] === 1,
      acquire: [{
        item: template_string_$item(_templateObject441 || (_templateObject441 = greyyou_taggedTemplateLiteral(["clockwork maid"]))),
        price: 7 * property_get("valueOfAdventure")
      }, {
        item: template_string_$item(_templateObject442 || (_templateObject442 = greyyou_taggedTemplateLiteral(["burning cape"])))
      }],
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject443 || (_templateObject443 = greyyou_taggedTemplateLiteral(["clockwork maid"])))),
      outfit: () => ({
        familiar: $familiars(_templateObject444 || (_templateObject444 = greyyou_taggedTemplateLiteral(["Trick-or-Treating Tot, Left-Hand Man, Disembodied Hand, Grey Goose"]))).find(fam => lib_have(fam)),
        modifier: "adventures".concat(args.pvp ? ", 0.3 fites" : "")
      })
    }, {
      name: "Summon Soap Knife",
      completed: () => !lib_have($skill(_templateObject445 || (_templateObject445 = greyyou_taggedTemplateLiteral(["That's Not a Knife"])))) || property_get("_discoKnife"),
      prepare: () => (0,external_kolmafia_namespaceObject.putCloset)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject446 || (_templateObject446 = greyyou_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject447 || (_templateObject447 = greyyou_taggedTemplateLiteral(["soap knife"])))),
      do: () => (0,external_kolmafia_namespaceObject.useSkill)($skill(_templateObject448 || (_templateObject448 = greyyou_taggedTemplateLiteral(["That's Not a Knife"])))),
      post: () => (0,external_kolmafia_namespaceObject.takeCloset)((0,external_kolmafia_namespaceObject.closetAmount)(template_string_$item(_templateObject449 || (_templateObject449 = greyyou_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject450 || (_templateObject450 = greyyou_taggedTemplateLiteral(["soap knife"]))))
    }, {
      name: "Tip the Author",
      //disabled by default - must manually discover and enable the flag
      ready: () => args.tip,
      completed: () => !lib_have(template_string_$item(_templateObject451 || (_templateObject451 = greyyou_taggedTemplateLiteral(["soap knife"])))),
