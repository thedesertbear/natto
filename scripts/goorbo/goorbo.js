...
function getGarden() {
  return utils_gardens.find(it => it.name in getCampground());
}
var banishes;
function nextUnusedBanishItem() {
  if (!banishes) banishes = template_string_$items(utils_templateObject32 || (utils_templateObject32 = utils_taggedTemplateLiteral(["human musk, tennis ball, Louder Than Bomb, divine champagne popper"]))).sort((a, b) => (0,external_kolmafia_namespaceObject.mallPrice)(a) - (0,external_kolmafia_namespaceObject.mallPrice)(b)); //sorted from cheapest to most expensive

  return banishes.find(it => !getBanishedMonsters().get(it)) || template_string_$item(utils_templateObject33 || (utils_templateObject33 = utils_taggedTemplateLiteral(["none"]))); //return the cheapest free banish not currently in use
}
function chewOrWish(it, ef) {
  if ((0,external_kolmafia_namespaceObject.mallPrice)(it) + (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(utils_templateObject34 || (utils_templateObject34 = utils_taggedTemplateLiteral(["mojo filter"])))) < (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(utils_templateObject35 || (utils_templateObject35 = utils_taggedTemplateLiteral(["pocket wish"]))))) {
    if ((0,external_kolmafia_namespaceObject.mySpleenUse)() === (0,external_kolmafia_namespaceObject.spleenLimit)()) (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(utils_templateObject36 || (utils_templateObject36 = utils_taggedTemplateLiteral(["mojo filter"]))));
    (0,external_kolmafia_namespaceObject.chew)(it);
  } else {
    (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(utils_templateObject37 || (utils_templateObject37 = utils_taggedTemplateLiteral(["pocket wish"]))));
...
function AftercoreQuest() {
  return {
    ...
    // },
    {
      ...
      completed: () => property_get("dailyDungeonDone") || (0,external_kolmafia_namespaceObject.getWorkshed)() !== template_string_$item(aftercore_templateObject2 || (aftercore_templateObject2 = aftercore_taggedTemplateLiteral(["Asdon Martin keyfob"]))) || (0,external_kolmafia_namespaceObject.haveEffect)($effect(aftercore_templateObject3 || (aftercore_templateObject3 = aftercore_taggedTemplateLiteral(["Driving Observantly"])))) >= 800,
      do: () => drive($effect(aftercore_templateObject4 || (aftercore_templateObject4 = aftercore_taggedTemplateLiteral(["Driving Observantly"]))), 810, false)
    }, {
      name: "Sample Constellation DNA",
      ready: () => lib_have(template_string_$item(aftercore_templateObject5 || (aftercore_templateObject5 = aftercore_taggedTemplateLiteral(["DNA extraction syringe"])))),
      completed: () => !DNALab_installed() || isHybridized($phylum(aftercore_templateObject6 || (aftercore_templateObject6 = aftercore_taggedTemplateLiteral(["Constellation"])))) || property_get("dnaSyringe") === $phylum(aftercore_templateObject7 || (aftercore_templateObject7 = aftercore_taggedTemplateLiteral(["Constellation"]))),
      outfit: {
        familiar: bestFam(),
        modifier: "".concat(maxBase())
      },
      do: $location(aftercore_templateObject8 || (aftercore_templateObject8 = aftercore_taggedTemplateLiteral(["The Hole in the Sky"]))),
      combat: new CombatStrategy().macro(Macro.skill($skill(aftercore_templateObject9 || (aftercore_templateObject9 = aftercore_taggedTemplateLiteral(["Infinite Loop"])))), getTodaysHolidayWanderers()).macro(Macro.tryItem(template_string_$item(aftercore_templateObject10 || (aftercore_templateObject10 = aftercore_taggedTemplateLiteral(["DNA extraction syringe"]))))).macro(Macro.tryItem(template_string_$item(aftercore_templateObject11 || (aftercore_templateObject11 = aftercore_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(aftercore_templateObject12 || (aftercore_templateObject12 = aftercore_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
    }, {
      name: "Hybridize Constellation",
      ready: () => property_get("dnaSyringe") === $phylum(aftercore_templateObject13 || (aftercore_templateObject13 = aftercore_taggedTemplateLiteral(["Constellation"]))),
      completed: () => !DNALab_installed() || isHybridized($phylum(aftercore_templateObject14 || (aftercore_templateObject14 = aftercore_taggedTemplateLiteral(["Constellation"])))),
      do: () => {
        hybridize();
        makeTonic(3);
      }
      ...
      name: "Install CMC",
      completed: () => (0,external_kolmafia_namespaceObject.getWorkshed)() === template_string_$item(aftercore_templateObject15 || (aftercore_templateObject15 = aftercore_taggedTemplateLiteral(["cold medicine cabinet"]))) || !lib_have(template_string_$item(aftercore_templateObject16 || (aftercore_templateObject16 = aftercore_taggedTemplateLiteral(["cold medicine cabinet"])))) || property_get("_workshedItemUsed"),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercore_templateObject17 || (aftercore_templateObject17 = aftercore_taggedTemplateLiteral(["cold medicine cabinet"]))))
    }, {
      name: "LGR Seed",
      completed: () => property_get("_stenchAirportToday") || property_get("stenchAirportAlways") || !lib_have(template_string_$item(aftercore_templateObject18 || (aftercore_templateObject18 = aftercore_taggedTemplateLiteral(["lucky gold ring"])))),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercore_templateObject19 || (aftercore_templateObject19 = aftercore_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"]))))
    }, {
      name: "June Cleaver",
      completed: () => !lib_have(template_string_$item(aftercore_templateObject20 || (aftercore_templateObject20 = aftercore_taggedTemplateLiteral(["June cleaver"])))) || property_get("_juneCleaverFightsLeft") > 0 || (0,external_kolmafia_namespaceObject.myAdventures)() === 0,
      choices: {
        793: 4,
        //The Shore -> Gift Shop
        1467: 3,
      ...
      prepare: () => {
        if (!(0,external_kolmafia_namespaceObject.canAdventure)($location(aftercore_templateObject21 || (aftercore_templateObject21 = aftercore_taggedTemplateLiteral(["The Shore, Inc. Travel Agency"]))))) (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(aftercore_templateObject22 || (aftercore_templateObject22 = aftercore_taggedTemplateLiteral(["bitchin' meatcar"]))));
      },
      do: $location(aftercore_templateObject23 || (aftercore_templateObject23 = aftercore_taggedTemplateLiteral(["The Shore, Inc. Travel Agency"]))),
      post: () => {
        if ((0,external_kolmafia_namespaceObject.handlingChoice)()) (0,external_kolmafia_namespaceObject.visitUrl)("main.php");
        if (lib_have($effect(aftercore_templateObject24 || (aftercore_templateObject24 = aftercore_taggedTemplateLiteral(["Beaten Up"]))))) uneffect($effect(aftercore_templateObject25 || (aftercore_templateObject25 = aftercore_taggedTemplateLiteral(["Beaten Up"]))));
      },
      outfit: () => ({
        equip: template_string_$items(aftercore_templateObject26 || (aftercore_templateObject26 = aftercore_taggedTemplateLiteral(["June cleaver"])))
      }),
      limit: undefined
    }, {
      name: "Restore HP",
      ...
      ready: () => lib_have(template_string_$item(aftercore_templateObject27 || (aftercore_templateObject27 = aftercore_taggedTemplateLiteral(["[glitch season reward name]"])))),
      completed: () => property_get("_glitchItemImplemented"),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercore_templateObject28 || (aftercore_templateObject28 = aftercore_taggedTemplateLiteral(["[glitch season reward name]"]))))
    }, {
      name: "Fight Glitch",
      ready: () => lib_have(template_string_$item(aftercore_templateObject29 || (aftercore_templateObject29 = aftercore_taggedTemplateLiteral(["[glitch season reward name]"])))),
      completed: () => property_get("_glitchMonsterFights") > 0,
      acquire: template_string_$items(aftercore_templateObject30 || (aftercore_templateObject30 = aftercore_taggedTemplateLiteral(["gas can, gas balloon, shard of double-ice"]))).map(it => ({
        item: it,
        price: 1000
      })),
      prepare: () => {
        (0,external_kolmafia_namespaceObject.restoreHp)(0.9 * (0,external_kolmafia_namespaceObject.myHp)());
        if (lib_have($skill(aftercore_templateObject31 || (aftercore_templateObject31 = aftercore_taggedTemplateLiteral(["Blood Bubble"])))) && !lib_have($effect(aftercore_templateObject32 || (aftercore_templateObject32 = aftercore_taggedTemplateLiteral(["Blood Bubble"]))))) (0,external_kolmafia_namespaceObject.useSkill)($skill(aftercore_templateObject33 || (aftercore_templateObject33 = aftercore_taggedTemplateLiteral(["Blood Bubble"]))));
      },
      ...
      combat: new CombatStrategy().macro(() => {
        var _Macro$tryItem$extern;

        return (_Macro$tryItem$extern = Macro.tryItem(template_string_$item(aftercore_templateObject34 || (aftercore_templateObject34 = aftercore_taggedTemplateLiteral(["gas balloon"])))).externalIf(lib_have($skill(aftercore_templateObject35 || (aftercore_templateObject35 = aftercore_taggedTemplateLiteral(["Feel Pride"])))) && property_get("_feelPrideUsed") < 3, Macro.trySkill($skill(aftercore_templateObject36 || (aftercore_templateObject36 = aftercore_taggedTemplateLiteral(["Feel Pride"])))), Macro.externalIf(template_string_$familiar(aftercore_templateObject37 || (aftercore_templateObject37 = aftercore_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(aftercore_templateObject38 || (aftercore_templateObject38 = aftercore_taggedTemplateLiteral(["Muscle"]))) ? $skill(aftercore_templateObject39 || (aftercore_templateObject39 = aftercore_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(aftercore_templateObject40 || (aftercore_templateObject40 = aftercore_taggedTemplateLiteral(["Mysticality"]))) ? $skill(aftercore_templateObject41 || (aftercore_templateObject41 = aftercore_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(aftercore_templateObject42 || (aftercore_templateObject42 = aftercore_taggedTemplateLiteral(["Convert Matter to Pomade"]))))))).tryItem.apply(_Macro$tryItem$extern, aftercore_toConsumableArray(template_string_$items(aftercore_templateObject43 || (aftercore_templateObject43 = aftercore_taggedTemplateLiteral(["shard of double-ice, gas can"]))))).attack().repeat();
      }),
      tracking: "Leveling"
    }, {
      name: "Daily Dungeon",
      completed: () => property_get("dailyDungeonDone"),
      acquire: template_string_$items(aftercore_templateObject44 || (aftercore_templateObject44 = aftercore_taggedTemplateLiteral(["eleven-foot pole, Pick-O-Matic lockpicks, ring of Detect Boring Doors"]))).map(it => ({
        item: it,
        price: 1000
      })),
      outfit: () => aftercore_objectSpread(aftercore_objectSpread({
        ...
        acc1: template_string_$item(aftercore_templateObject45 || (aftercore_templateObject45 = aftercore_taggedTemplateLiteral(["ring of Detect Boring Doors"])))
      } : {}), {}, {
        modifier: "".concat(maxBase(), ", 250 bonus carnivorous potted plant")
      }),
      prepare: () => {
        if (!property_get("_dailyDungeonMalwareUsed") && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(aftercore_templateObject46 || (aftercore_templateObject46 = aftercore_taggedTemplateLiteral(["fat loot token"])))) < 3 && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(aftercore_templateObject47 || (aftercore_templateObject47 = aftercore_taggedTemplateLiteral(["daily dungeon malware"])))) === 0) {
          if ((0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(aftercore_templateObject48 || (aftercore_templateObject48 = aftercore_taggedTemplateLiteral(["BACON"])))) >= 150) (0,external_kolmafia_namespaceObject.buy)($coinmaster(aftercore_templateObject49 || (aftercore_templateObject49 = aftercore_taggedTemplateLiteral(["internet meme shop"]))), 1, template_string_$item(aftercore_templateObject50 || (aftercore_templateObject50 = aftercore_taggedTemplateLiteral(["daily dungeon malware"]))));else (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(aftercore_templateObject51 || (aftercore_templateObject51 = aftercore_taggedTemplateLiteral(["daily dungeon malware"]))));
        }
      ...
      combat: new CombatStrategy().macro(() => Macro.step("pickpocket").externalIf(!property_get("_dailyDungeonMalwareUsed"), Macro.tryItem(template_string_$item(aftercore_templateObject53 || (aftercore_templateObject53 = aftercore_taggedTemplateLiteral(["daily dungeon malware"]))))).tryItem(template_string_$item(aftercore_templateObject54 || (aftercore_templateObject54 = aftercore_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(aftercore_templateObject55 || (aftercore_templateObject55 = aftercore_taggedTemplateLiteral(["Saucestorm"])))).attack().repeat()),
      limit: {
        tries: 15
      }
    }, {
      ...
      completed: () => !targetPerms(false).find(sk => !lib_have(sk) && $skills(aftercore_templateObject56 || (aftercore_templateObject56 = aftercore_taggedTemplateLiteral(["Torso Awareness, Gnefarious Pickpocketing, Powers of Observatiogn, Gnomish Hardigness, Cosmic Ugnderstanding"]))).includes(sk)),
      do: () => targetPerms(false).filter(sk => !lib_have(sk) && $skills(aftercore_templateObject57 || (aftercore_templateObject57 = aftercore_taggedTemplateLiteral(["Torso Awareness, Gnefarious Pickpocketing, Powers of Observatiogn, Gnomish Hardigness, Cosmic Ugnderstanding"]))).includes(sk)).forEach(sk => (0,external_kolmafia_namespaceObject.visitUrl)("gnomes.php?action=trainskill&whichskill=".concat((0,external_kolmafia_namespaceObject.toInt)(sk)), true)),
      limit: {
        tries: 5
      }
    }, {
      ...
      !!targetPerms(false).find(sk => !lib_have(sk) && sk.level > 0) || (0,external_kolmafia_namespaceObject.myClass)() === $class(aftercore_templateObject58 || (aftercore_templateObject58 = aftercore_taggedTemplateLiteral(["Seal Clubber"]))) && Math.min.apply(Math, aftercore_toConsumableArray(template_string_$items(aftercore_templateObject59 || (aftercore_templateObject59 = aftercore_taggedTemplateLiteral(["figurine of a wretched-looking seal, seal-blubber candle"]))).map(it => (0,external_kolmafia_namespaceObject.availableAmount)(it)))) < 20,
      ...
      outfit: () => ({
        familiar: bestFam(),
        modifier: "".concat(maxBase(), ", ").concat((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(aftercore_templateObject60 || (aftercore_templateObject60 = aftercore_taggedTemplateLiteral(["Muscle"]))) ? "100 combat rate 20 max" : "-100 combat rate", ", 250 bonus carnivorous potted plant")
      }),
      combat: new CombatStrategy().macro(() => Macro.step("pickpocket").externalIf(lib_have($skill(aftercore_templateObject61 || (aftercore_templateObject61 = aftercore_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill($skill(aftercore_templateObject62 || (aftercore_templateObject62 = aftercore_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(aftercore_templateObject63 || (aftercore_templateObject63 = aftercore_taggedTemplateLiteral(["electronics kit"]))))).tryItem(template_string_$item(aftercore_templateObject64 || (aftercore_templateObject64 = aftercore_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(aftercore_templateObject65 || (aftercore_templateObject65 = aftercore_taggedTemplateLiteral(["Sing Along"])))).attack().repeat(), getTodaysHolidayWanderers()).macro(() => Macro.step("pickpocket").tryItem(template_string_$item(aftercore_templateObject66 || (aftercore_templateObject66 = aftercore_taggedTemplateLiteral(["porquoise-handled sixgun"])))).attack().repeat())
    }, {
      ...
      ready: () => (0,external_kolmafia_namespaceObject.guildStoreAvailable)() && ((0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(aftercore_templateObject67 || (aftercore_templateObject67 = aftercore_taggedTemplateLiteral(["Mysticality"]))) || (0,external_kolmafia_namespaceObject.myClass)() === $class(aftercore_templateObject68 || (aftercore_templateObject68 = aftercore_taggedTemplateLiteral(["Accordion Thief"]))) && (0,external_kolmafia_namespaceObject.myLevel)() >= 9),
      completed: () => (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(aftercore_templateObject69 || (aftercore_templateObject69 = aftercore_taggedTemplateLiteral(["magical mystery juice"])))) >= 500,
      acquire: [{
        item: template_string_$item(aftercore_templateObject70 || (aftercore_templateObject70 = aftercore_taggedTemplateLiteral(["magical mystery juice"]))),
        num: 500
      }],
      do: () => false
    }, {
      name: "Buy Seal Summoning Supplies",
      ready: () => (0,external_kolmafia_namespaceObject.myClass)() === $class(aftercore_templateObject71 || (aftercore_templateObject71 = aftercore_taggedTemplateLiteral(["Seal Clubber"]))) && (0,external_kolmafia_namespaceObject.guildStoreAvailable)(),
      completed: () => Math.min.apply(Math, aftercore_toConsumableArray(template_string_$items(aftercore_templateObject72 || (aftercore_templateObject72 = aftercore_taggedTemplateLiteral(["figurine of a wretched-looking seal, seal-blubber candle"]))).map(it => (0,external_kolmafia_namespaceObject.availableAmount)(it)))) >= 20,
      acquire: template_string_$items(aftercore_templateObject73 || (aftercore_templateObject73 = aftercore_taggedTemplateLiteral(["figurine of a wretched-looking seal, seal-blubber candle"]))).map(it => ({
        item: it,
        num: 500
      })),
      do: () => false
      ...
      prepare: () => uneffect($effect(aftercore_templateObject74 || (aftercore_templateObject74 = aftercore_taggedTemplateLiteral(["Beaten Up"])))),
      ...
      name: "Garbo",
      completed: () => args.voatest || stooperDrunk() || !canDiet() && (0,external_kolmafia_namespaceObject.myAdventures)() === 0,
      prepare: () => uneffect($effect(aftercore_templateObject77 || (aftercore_templateObject77 = aftercore_taggedTemplateLiteral(["Beaten Up"])))),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("".concat(args.garboascend)),
      post: () => $effects(aftercore_templateObject78 || (aftercore_templateObject78 = aftercore_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef)),
      tracking: "Garbo"
    }, {
      name: "Stooper",
      ready: () => (0,external_kolmafia_namespaceObject.myInebriety)() === (0,external_kolmafia_namespaceObject.inebrietyLimit)() && lib_have(template_string_$item(aftercore_templateObject79 || (aftercore_templateObject79 = aftercore_taggedTemplateLiteral(["tiny stillsuit"])))) && property_get("familiarSweat") >= 300,
      completed: () => !lib_have(template_string_$familiar(aftercore_templateObject80 || (aftercore_templateObject80 = aftercore_taggedTemplateLiteral(["Stooper"])))) || stooperDrunk(),
      do: () => {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(aftercore_templateObject81 || (aftercore_templateObject81 = aftercore_taggedTemplateLiteral(["Stooper"]))));
        (0,external_kolmafia_namespaceObject.cliExecute)("drink stillsuit distillate");
      }
    }, {
      name: "Nightcap",
      ready: () => lib_have(template_string_$item(aftercore_templateObject82 || (aftercore_templateObject82 = aftercore_taggedTemplateLiteral(["Drunkula's wineglass"])))),
      completed: () => totallyDrunk(),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("CONSUME NIGHTCAP VALUE ".concat(property_get("valueOfAdventure") - 1000))
    }, {
      name: "Garbo (Drunk)",
      ready: () => lib_have(template_string_$item(aftercore_templateObject83 || (aftercore_templateObject83 = aftercore_taggedTemplateLiteral(["Drunkula's wineglass"])))),
      prepare: () => uneffect($effect(aftercore_templateObject84 || (aftercore_templateObject84 = aftercore_taggedTemplateLiteral(["Beaten Up"])))),
      ...
      post: () => $effects(aftercore_templateObject85 || (aftercore_templateObject85 = aftercore_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef)),
      tracking: "Garbo"
    }, {
      name: "Turn in FunFunds",
      ready: () => property_get("_stenchAirportToday") && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject86 || (_templateObject86 = aftercore_taggedTemplateLiteral(["FunFunds\u2122"])))) >= 20,
      completed: () => lib_have(template_string_$item(_templateObject87 || (_templateObject87 = aftercore_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      do: () => (0,external_kolmafia_namespaceObject.buy)($coinmaster(_templateObject88 || (_templateObject88 = aftercore_taggedTemplateLiteral(["The Dinsey Company Store"]))), 1, template_string_$item(_templateObject89 || (_templateObject89 = aftercore_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      tracking: "Garbo"
    }, {
      name: "PvP",
      ...
      completed: () => !lib_have($skill(_templateObject90 || (_templateObject90 = aftercore_taggedTemplateLiteral(["That's Not a Knife"])))) || property_get("_discoKnife"),
      prepare: () => (0,external_kolmafia_namespaceObject.putCloset)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject91 || (_templateObject91 = aftercore_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject92 || (_templateObject92 = aftercore_taggedTemplateLiteral(["soap knife"])))),
      do: () => (0,external_kolmafia_namespaceObject.useSkill)($skill(_templateObject93 || (_templateObject93 = aftercore_taggedTemplateLiteral(["That's Not a Knife"])))),
      post: () => (0,external_kolmafia_namespaceObject.takeCloset)((0,external_kolmafia_namespaceObject.closetAmount)(template_string_$item(_templateObject94 || (_templateObject94 = aftercore_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject95 || (_templateObject95 = aftercore_taggedTemplateLiteral(["soap knife"]))))
    }, {
      ...
      do: () => {
        ...
        var nPerms = targetPerms(true);
        var moonsign = toMoonSign(lib_have(template_string_$item(_templateObject96 || (_templateObject96 = aftercore_taggedTemplateLiteral(["hewn moon-rune spoon"])))) || !$skills(_templateObject97 || (_templateObject97 = aftercore_taggedTemplateLiteral(["Torso Awareness, Gnefarious Pickpocketing, Powers of Observatiogn, Gnomish Hardigness, Cosmic Ugnderstanding"]))).find(sk => !(sk.name in (0,external_kolmafia_namespaceObject.getPermedSkills)()) //skip checking gnomes if you have a moon spoon or have all gnome skills permed
        ) ? args.moonsign : nPerms.includes($skill(_templateObject98 || (_templateObject98 = aftercore_taggedTemplateLiteral(["Torso Awareness"])))) || !$skills(_templateObject99 || (_templateObject99 = aftercore_taggedTemplateLiteral(["Gnefarious Pickpocketing, Powers of Observatiogn, Gnomish Hardigness, Cosmic Ugnderstanding"]))).find(sk => !nPerms.includes(sk) //plan to perm Torso Awareness or all 4 other gnome skills
        ) ? "wombat" : args.moonsign);
        ascend($path(_templateObject100 || (_templateObject100 = aftercore_taggedTemplateLiteral(["Grey You"]))), $class(_templateObject101 || (_templateObject101 = aftercore_taggedTemplateLiteral(["Grey Goo"]))), Lifestyle.softcore, moonsign, template_string_$item(_templateObject102 || (_templateObject102 = aftercore_taggedTemplateLiteral(["astral six-pack"]))), args.astralpet === template_string_$item(_templateObject103 || (_templateObject103 = aftercore_taggedTemplateLiteral(["none"]))) ? undefined : args.astralpet, {
...
function Robortender_have() {
  return haveFamiliar(Robortender_familiar);
}
...
function GyouQuest() {
  return {
    ...
    tasks: [{
      ...
      name: "Meat Boombox",
      completed: () => !lib_have(template_string_$item(greyyou_templateObject26 || (greyyou_templateObject26 = greyyou_taggedTemplateLiteral(["SongBoom\u2122 BoomBox"])))) || property_get("boomBoxSong") === "Total Eclipse of Your Meat" || property_get("_boomBoxSongsLeft") === 0,
      do: () => setSong("Total Eclipse of Your Meat")
    }, {
      name: "Install Alternate Workshed",
      ready: () => lib_have(altWorkshed()),
      completed: () => altWorkshed() === template_string_$item(greyyou_templateObject27 || (greyyou_templateObject27 = greyyou_taggedTemplateLiteral(["none"]))) || property_get("_workshedItemUsed") || (0,external_kolmafia_namespaceObject.getWorkshed)() === altWorkshed(),
      do: () => (0,external_kolmafia_namespaceObject.use)(altWorkshed())
    }, {
      name: "Make Soda Bread",
      completed: () => (0,external_kolmafia_namespaceObject.myTurncount)() >= 1000 || (0,external_kolmafia_namespaceObject.getWorkshed)() !== template_string_$item(greyyou_templateObject28 || (greyyou_templateObject28 = greyyou_taggedTemplateLiteral(["Asdon Martin keyfob"]))) || lib_have($effect(greyyou_templateObject29 || (greyyou_templateObject29 = greyyou_taggedTemplateLiteral(["Driving Observantly"])))) || (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(greyyou_templateObject30 || (greyyou_templateObject30 = greyyou_taggedTemplateLiteral(["loaf of soda bread"])))) >= 10,
      do: () => {
        if ((0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(greyyou_templateObject31 || (greyyou_templateObject31 = greyyou_taggedTemplateLiteral(["wad of dough"])))) < 10) {
          (0,external_kolmafia_namespaceObject.buy)(template_string_$item(greyyou_templateObject32 || (greyyou_templateObject32 = greyyou_taggedTemplateLiteral(["all-purpose flower"]))));
          (0,external_kolmafia_namespaceObject.use)(template_string_$item(greyyou_templateObject33 || (greyyou_templateObject33 = greyyou_taggedTemplateLiteral(["all-purpose flower"]))));
        }

        (0,external_kolmafia_namespaceObject.retrieveItem)(10, template_string_$item(greyyou_templateObject34 || (greyyou_templateObject34 = greyyou_taggedTemplateLiteral(["loaf of soda bread"]))));
      }
    }, {
      name: "Drive Observantly",
      completed: () => (0,external_kolmafia_namespaceObject.getWorkshed)() !== template_string_$item(greyyou_templateObject35 || (greyyou_templateObject35 = greyyou_taggedTemplateLiteral(["Asdon Martin keyfob"]))) || lib_have($effect(greyyou_templateObject36 || (greyyou_templateObject36 = greyyou_taggedTemplateLiteral(["Driving Observantly"])))),
      do: () => drive($effect(greyyou_templateObject37 || (greyyou_templateObject37 = greyyou_taggedTemplateLiteral(["Driving Observantly"]))), 30, false)
    }, {
      name: "Sample Constellation DNA",
      ready: () => lib_have(template_string_$item(greyyou_templateObject38 || (greyyou_templateObject38 = greyyou_taggedTemplateLiteral(["DNA extraction syringe"])))),
      completed: () => !DNALab_installed() || isHybridized($phylum(greyyou_templateObject39 || (greyyou_templateObject39 = greyyou_taggedTemplateLiteral(["Constellation"])))) || property_get("dnaSyringe") === $phylum(greyyou_templateObject40 || (greyyou_templateObject40 = greyyou_taggedTemplateLiteral(["Constellation"]))),
      outfit: {
        familiar: bestFam(),
        modifier: "".concat(maxBase())
      },
      do: $location(greyyou_templateObject41 || (greyyou_templateObject41 = greyyou_taggedTemplateLiteral(["The Hole in the Sky"]))),
      combat: new CombatStrategy().macro(Macro.skill($skill(greyyou_templateObject42 || (greyyou_templateObject42 = greyyou_taggedTemplateLiteral(["Infinite Loop"])))), getTodaysHolidayWanderers()).macro(Macro.tryItem(template_string_$item(greyyou_templateObject43 || (greyyou_templateObject43 = greyyou_taggedTemplateLiteral(["DNA extraction syringe"]))))).macro(Macro.tryItem(template_string_$item(greyyou_templateObject44 || (greyyou_templateObject44 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(greyyou_templateObject45 || (greyyou_templateObject45 = greyyou_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
    }, {
      name: "Hybridize Constellation",
      ready: () => property_get("dnaSyringe") === $phylum(greyyou_templateObject46 || (greyyou_templateObject46 = greyyou_taggedTemplateLiteral(["Constellation"]))),
      completed: () => !DNALab_installed() || isHybridized($phylum(greyyou_templateObject47 || (greyyou_templateObject47 = greyyou_taggedTemplateLiteral(["Constellation"])))),
      do: () => {
        makeTonic(3);
        hybridize();
      }
      ...
      ready: () => lib_have(template_string_$item(greyyou_templateObject48 || (greyyou_templateObject48 = greyyou_taggedTemplateLiteral(["boxed wine"])))) && meatFam() === template_string_$familiar(greyyou_templateObject49 || (greyyou_templateObject49 = greyyou_taggedTemplateLiteral(["Robortender"]))),
      completed: () => !lib_have(template_string_$item(greyyou_templateObject50 || (greyyou_templateObject50 = greyyou_taggedTemplateLiteral(["miniature crystal ball"])))) || !lib_have(template_string_$familiar(greyyou_templateObject51 || (greyyou_templateObject51 = greyyou_taggedTemplateLiteral(["Robortender"])))) || currentDrinks().includes(template_string_$item(greyyou_templateObject52 || (greyyou_templateObject52 = greyyou_taggedTemplateLiteral(["drive-by shooting"])))) || lib_have(template_string_$item(greyyou_templateObject53 || (greyyou_templateObject53 = greyyou_taggedTemplateLiteral(["fish head"])))) || lib_have(template_string_$item(greyyou_templateObject54 || (greyyou_templateObject54 = greyyou_taggedTemplateLiteral(["piscatini"])))) || lib_have(template_string_$item(greyyou_templateObject55 || (greyyou_templateObject55 = greyyou_taggedTemplateLiteral(["drive-by shooting"])))),
      outfit: {
        familiar: property_get("crystalBallPredictions").includes(":The Copperhead Club:Mob Penguin Capo") ? template_string_$familiar(greyyou_templateObject56 || (greyyou_templateObject56 = greyyou_taggedTemplateLiteral(["Robortender"]))) : lib_have(template_string_$familiar(greyyou_templateObject57 || (greyyou_templateObject57 = greyyou_taggedTemplateLiteral(["Red-Nosed Snapper"])))) ? template_string_$familiar(greyyou_templateObject58 || (greyyou_templateObject58 = greyyou_taggedTemplateLiteral(["Red-Nosed Snapper"]))) : bestFam(),
        famequip: template_string_$item(greyyou_templateObject59 || (greyyou_templateObject59 = greyyou_taggedTemplateLiteral(["miniature crystal ball"]))),
      ...
      prepare: () => {
        if ((0,external_kolmafia_namespaceObject.myFamiliar)() === template_string_$familiar(greyyou_templateObject60 || (greyyou_templateObject60 = greyyou_taggedTemplateLiteral(["Red-Nosed Snapper"]))) && getTrackedPhylum() !== $phylum(greyyou_templateObject61 || (greyyou_templateObject61 = greyyou_taggedTemplateLiteral(["penguin"])))) trackPhylum($phylum(greyyou_templateObject62 || (greyyou_templateObject62 = greyyou_taggedTemplateLiteral(["penguin"]))));
        (0,external_kolmafia_namespaceObject.restoreHp)(0.75 * (0,external_kolmafia_namespaceObject.myMaxhp)());
        (0,external_kolmafia_namespaceObject.restoreMp)(20);
      },
      do: $location(greyyou_templateObject63 || (greyyou_templateObject63 = greyyou_taggedTemplateLiteral(["The Copperhead Club"]))),
      combat: new CombatStrategy().macro(Macro.skill($skill(greyyou_templateObject64 || (greyyou_templateObject64 = greyyou_taggedTemplateLiteral(["Infinite Loop"])))), getTodaysHolidayWanderers()) // .macro(Macro.trySkill($skill`Offer Latte to Opponent`), $monster`Mob Penguin Capo`)
      .macro(() => Macro.externalIf(!$monsters(greyyou_templateObject65 || (greyyou_templateObject65 = greyyou_taggedTemplateLiteral(["Copperhead Club bartender, fan dancer, ninja dressed as a waiter, waiter dressed as a ninja"]))).find(mob => mob === getBanishedMonsters().get($skill(greyyou_templateObject66 || (greyyou_templateObject66 = greyyou_taggedTemplateLiteral(["System Sweep"])))) //get("banishedMonsters").includes(`${mob.name}:System Sweep`)
      ), Macro.trySkill($skill(greyyou_templateObject67 || (greyyou_templateObject67 = greyyou_taggedTemplateLiteral(["System Sweep"]))))), $monsters(greyyou_templateObject68 || (greyyou_templateObject68 = greyyou_taggedTemplateLiteral(["Copperhead Club bartender, fan dancer, ninja dressed as a waiter, waiter dressed as a ninja"])))).macro(Macro.tryItem(template_string_$item(greyyou_templateObject69 || (greyyou_templateObject69 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(greyyou_templateObject70 || (greyyou_templateObject70 = greyyou_taggedTemplateLiteral(["Sing Along"])))).attack().repeat()),
      limit: {
        tries: 10
      }
    }, {
      name: "Feed Robortender",
      ready: () => lib_have(template_string_$item(greyyou_templateObject71 || (greyyou_templateObject71 = greyyou_taggedTemplateLiteral(["boxed wine"])))) && lib_have(template_string_$item(greyyou_templateObject72 || (greyyou_templateObject72 = greyyou_taggedTemplateLiteral(["fish head"])))) || lib_have(template_string_$item(greyyou_templateObject73 || (greyyou_templateObject73 = greyyou_taggedTemplateLiteral(["piscatini"])))) || lib_have(template_string_$item(greyyou_templateObject74 || (greyyou_templateObject74 = greyyou_taggedTemplateLiteral(["drive-by shooting"])))),
      completed: () => !lib_have(template_string_$familiar(greyyou_templateObject75 || (greyyou_templateObject75 = greyyou_taggedTemplateLiteral(["Robortender"])))) || currentDrinks().includes(template_string_$item(greyyou_templateObject76 || (greyyou_templateObject76 = greyyou_taggedTemplateLiteral(["drive-by shooting"])))),
      do: () => {
        (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(greyyou_templateObject77 || (greyyou_templateObject77 = greyyou_taggedTemplateLiteral(["drive-by shooting"]))));
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(greyyou_templateObject78 || (greyyou_templateObject78 = greyyou_taggedTemplateLiteral(["Robortender"]))));
        feed(template_string_$item(greyyou_templateObject79 || (greyyou_templateObject79 = greyyou_taggedTemplateLiteral(["drive-by shooting"]))));
      }
    }, {
      name: "In-Run Farm Initial",
      completed: () => (0,external_kolmafia_namespaceObject.myTurncount)() >= 1000,
      do: $location(greyyou_templateObject80 || (greyyou_templateObject80 = greyyou_taggedTemplateLiteral(["Barf Mountain"]))),
      prepare: () => {
        if (lib_have(template_string_$item(greyyou_templateObject81 || (greyyou_templateObject81 = greyyou_taggedTemplateLiteral(["How to Avoid Scams"]))))) ensureEffect($effect(greyyou_templateObject82 || (greyyou_templateObject82 = greyyou_taggedTemplateLiteral(["How to Scam Tourists"]))));
        (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(greyyou_templateObject83 || (greyyou_templateObject83 = greyyou_taggedTemplateLiteral(["seal tooth"]))));
        (0,external_kolmafia_namespaceObject.restoreHp)(0.75 * (0,external_kolmafia_namespaceObject.myMaxhp)());
        (0,external_kolmafia_namespaceObject.restoreMp)(20);
      },
      outfit: {
      ...
      combat: new CombatStrategy().macro(Macro.skill($skill(greyyou_templateObject84 || (greyyou_templateObject84 = greyyou_taggedTemplateLiteral(["Infinite Loop"])))), getTodaysHolidayWanderers()).macro(Macro.trySkill($skill(greyyou_templateObject85 || (greyyou_templateObject85 = greyyou_taggedTemplateLiteral(["Bowl Straight Up"])))).trySkill($skill(greyyou_templateObject86 || (greyyou_templateObject86 = greyyou_taggedTemplateLiteral(["Sing Along"])))).trySkill($skill(greyyou_templateObject87 || (greyyou_templateObject87 = greyyou_taggedTemplateLiteral(["Extract Jelly"])))).tryItem(template_string_$item(greyyou_templateObject88 || (greyyou_templateObject88 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).tryItem(template_string_$item(greyyou_templateObject89 || (greyyou_templateObject89 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(greyyou_templateObject90 || (greyyou_templateObject90 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(greyyou_templateObject91 || (greyyou_templateObject91 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(greyyou_templateObject92 || (greyyou_templateObject92 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(greyyou_templateObject93 || (greyyou_templateObject93 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(greyyou_templateObject94 || (greyyou_templateObject94 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(greyyou_templateObject95 || (greyyou_templateObject95 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(greyyou_templateObject96 || (greyyou_templateObject96 = greyyou_taggedTemplateLiteral(["seal tooth"])))).trySkill($skill(greyyou_templateObject97 || (greyyou_templateObject97 = greyyou_taggedTemplateLiteral(["Double Nanovision"])))).attack().repeat()),
      limit: {
        tries: 550
      },
      tracking: "GooFarming"
      ...
      name: "Pull All",
      completed: () => (0,external_kolmafia_namespaceObject.myStorageMeat)() === 0 && (0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(greyyou_templateObject98 || (greyyou_templateObject98 = greyyou_taggedTemplateLiteral(["old sweatpants"])))) === 0,
      // arbitrary item
      do: () => {
      ...
      ready: () => lib_have(template_string_$familiar(greyyou_templateObject99 || (greyyou_templateObject99 = greyyou_taggedTemplateLiteral(["Cornbeefadon"])))),
      completed: () => lib_have(template_string_$item(greyyou_templateObject100 || (greyyou_templateObject100 = greyyou_taggedTemplateLiteral(["amulet coin"])))),
      acquire: [{
        item: template_string_$item(greyyou_templateObject101 || (greyyou_templateObject101 = greyyou_taggedTemplateLiteral(["box of Familiar Jacks"]))),
        price: 20000
      }],
      do: () => {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(greyyou_templateObject102 || (greyyou_templateObject102 = greyyou_taggedTemplateLiteral(["Cornbeefadon"]))));
        (0,external_kolmafia_namespaceObject.use)(template_string_$item(greyyou_templateObject103 || (greyyou_templateObject103 = greyyou_taggedTemplateLiteral(["box of Familiar Jacks"]))));
      }
    }, {
      name: "Tower",
      ...
      name: "Daily Dungeon",
      ready: () => (0,external_kolmafia_namespaceObject.myClass)() === $class(_templateObject104 || (_templateObject104 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myAdventures)() > 40 || (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject105 || (_templateObject105 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel,
      completed: () => property_get("dailyDungeonDone"),
      acquire: template_string_$items(_templateObject106 || (_templateObject106 = greyyou_taggedTemplateLiteral(["eleven-foot pole, Pick-O-Matic lockpicks, ring of Detect Boring Doors"]))).map(it => ({
        item: it,
        price: 1000
      })),
      outfit: () => {
        return greyyou_objectSpread(greyyou_objectSpread({
          ...
          acc1: template_string_$item(_templateObject107 || (_templateObject107 = greyyou_taggedTemplateLiteral(["ring of Detect Boring Doors"])))
        } : {}), {}, {
          modifier: "".concat(maxBase(), ", 250 bonus carnivorous potted plant, 100 familiar experience")
        });
      },
      prepare: () => {
        if (!property_get("_dailyDungeonMalwareUsed") && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject108 || (_templateObject108 = greyyou_taggedTemplateLiteral(["fat loot token"])))) < 3 && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject109 || (_templateObject109 = greyyou_taggedTemplateLiteral(["daily dungeon malware"])))) === 0) {
          if ((0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject110 || (_templateObject110 = greyyou_taggedTemplateLiteral(["BACON"])))) >= 150) (0,external_kolmafia_namespaceObject.buy)($coinmaster(_templateObject111 || (_templateObject111 = greyyou_taggedTemplateLiteral(["internet meme shop"]))), 1, template_string_$item(_templateObject112 || (_templateObject112 = greyyou_taggedTemplateLiteral(["daily dungeon malware"]))));else (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject113 || (_templateObject113 = greyyou_taggedTemplateLiteral(["daily dungeon malware"]))));
        }

        (0,external_kolmafia_namespaceObject.restoreHp)(0.75 * (0,external_kolmafia_namespaceObject.myMaxhp)());
        (0,external_kolmafia_namespaceObject.restoreMp)(20);
      },
      do: $location(_templateObject114 || (_templateObject114 = greyyou_taggedTemplateLiteral(["The Daily Dungeon"]))),
      choices: {
        692: 3,
        //dd door: lockpicks
        689: 1,
      ...
      combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject115 || (_templateObject115 = greyyou_taggedTemplateLiteral(["Infinite Loop"])))), getTodaysHolidayWanderers()).macro(() => Macro.externalIf(!property_get("_dailyDungeonMalwareUsed"), Macro.tryItem(template_string_$item(_templateObject116 || (_templateObject116 = greyyou_taggedTemplateLiteral(["daily dungeon malware"]))))).tryItem(template_string_$item(_templateObject117 || (_templateObject117 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).attack().repeat()),
      limit: {
        tries: 15
      }
    }, {
      name: "Laugh Floor",
      ready: () => (0,external_kolmafia_namespaceObject.myClass)() === $class(_templateObject118 || (_templateObject118 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myAdventures)() > 40 || (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject119 || (_templateObject119 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel,
      completed: () => lib_have($skill(_templateObject120 || (_templateObject120 = greyyou_taggedTemplateLiteral(["Liver of Steel"])))) || lib_have(template_string_$item(_templateObject121 || (_templateObject121 = greyyou_taggedTemplateLiteral(["steel margarita"])))) || lib_have(template_string_$item(_templateObject122 || (_templateObject122 = greyyou_taggedTemplateLiteral(["Azazel's lollipop"])))) || lib_have(template_string_$item(_templateObject123 || (_templateObject123 = greyyou_taggedTemplateLiteral(["observational glasses"])))),
      prepare: () => {
        //add casting of +com skills here. Also request buffs from buffy?
        if (!lib_have($effect(_templateObject124 || (_templateObject124 = greyyou_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"]))))) {
        ...
        if (lib_have($skill(_templateObject125 || (_templateObject125 = greyyou_taggedTemplateLiteral(["Piezoelectric Honk"])))) && !lib_have($effect(_templateObject126 || (_templateObject126 = greyyou_taggedTemplateLiteral(["Hooooooooonk!"]))))) (0,external_kolmafia_namespaceObject.useSkill)($skill(_templateObject127 || (_templateObject127 = greyyou_taggedTemplateLiteral(["Piezoelectric Honk"]))));
        $effects(_templateObject128 || (_templateObject128 = greyyou_taggedTemplateLiteral(["The Sonata of Sneakiness, Darkened Photons, Shifted Phase"]))).forEach(ef => (0,external_kolmafia_namespaceObject.cliExecute)("uneffect ".concat(ef)));
      },
      do: $location(_templateObject129 || (_templateObject129 = greyyou_taggedTemplateLiteral(["The Laugh Floor"]))),
      outfit: () => ({
        familiar: bestFam(),
        modifier: "".concat(maxBase(), ", 100 combat rate, 3 item, 250 bonus carnivorous potted plant, 100 familiar experience")
      }),
      combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject130 || (_templateObject130 = greyyou_taggedTemplateLiteral(["Infinite Loop"])))), getTodaysHolidayWanderers()).macro(Macro.tryItem(template_string_$item(_templateObject131 || (_templateObject131 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(_templateObject132 || (_templateObject132 = greyyou_taggedTemplateLiteral(["Double Nanovision"])))).attack().repeat()),
      limit: {
        tries: 15
      }
    }, {
      name: "Infernal Rackets Backstage",
      ready: () => (0,external_kolmafia_namespaceObject.myClass)() === $class(_templateObject133 || (_templateObject133 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myAdventures)() > 40 || (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject134 || (_templateObject134 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel,
      completed: () => lib_have($skill(_templateObject135 || (_templateObject135 = greyyou_taggedTemplateLiteral(["Liver of Steel"])))) || lib_have(template_string_$item(_templateObject136 || (_templateObject136 = greyyou_taggedTemplateLiteral(["steel margarita"])))) || lib_have(template_string_$item(_templateObject137 || (_templateObject137 = greyyou_taggedTemplateLiteral(["Azazel's unicorn"])))) || backstageItemsDone(),
      prepare: () => {
        //add casting of -com skills here. Also request buffs from buffy?
        if (!lib_have($effect(_templateObject138 || (_templateObject138 = greyyou_taggedTemplateLiteral(["The Sonata of Sneakiness"]))))) {
        ...
        if (lib_have($skill(_templateObject139 || (_templateObject139 = greyyou_taggedTemplateLiteral(["Photonic Shroud"])))) && !lib_have($effect(_templateObject140 || (_templateObject140 = greyyou_taggedTemplateLiteral(["Darkened Photons"]))))) (0,external_kolmafia_namespaceObject.useSkill)($skill(_templateObject141 || (_templateObject141 = greyyou_taggedTemplateLiteral(["Photonic Shroud"]))));
        if (lib_have($skill(_templateObject142 || (_templateObject142 = greyyou_taggedTemplateLiteral(["Phase Shift"])))) && !lib_have($effect(_templateObject143 || (_templateObject143 = greyyou_taggedTemplateLiteral(["Shifted Phase"]))))) (0,external_kolmafia_namespaceObject.useSkill)($skill(_templateObject144 || (_templateObject144 = greyyou_taggedTemplateLiteral(["Phase Shift"]))));
        $effects(_templateObject145 || (_templateObject145 = greyyou_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation, Hooooooooonk!"]))).forEach(ef => (0,external_kolmafia_namespaceObject.cliExecute)("uneffect ".concat(ef)));
      },
      do: $location(_templateObject146 || (_templateObject146 = greyyou_taggedTemplateLiteral(["Infernal Rackets Backstage"]))),
      outfit: () => ({
        familiar: bestFam(),
        modifier: "".concat(maxBase(), ", -100 combat rate, 3 item, 250 bonus carnivorous potted plant, 100 familiar experience")
      }),
      combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject147 || (_templateObject147 = greyyou_taggedTemplateLiteral(["Infinite Loop"])))), getTodaysHolidayWanderers()).macro(Macro.tryItem(template_string_$item(_templateObject148 || (_templateObject148 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(_templateObject149 || (_templateObject149 = greyyou_taggedTemplateLiteral(["Double Nanovision"])))).repeat()),
      limit: {
        tries: 15
      }
    }, {
      name: "Mourn",
      ready: () => lib_have(template_string_$item(_templateObject150 || (_templateObject150 = greyyou_taggedTemplateLiteral(["observational glasses"])))),
      completed: () => lib_have($skill(_templateObject151 || (_templateObject151 = greyyou_taggedTemplateLiteral(["Liver of Steel"])))) || lib_have(template_string_$item(_templateObject152 || (_templateObject152 = greyyou_taggedTemplateLiteral(["steel margarita"])))) || lib_have(template_string_$item(_templateObject153 || (_templateObject153 = greyyou_taggedTemplateLiteral(["Azazel's lollipop"])))),
      outfit: {
        equip: template_string_$items(_templateObject154 || (_templateObject154 = greyyou_taggedTemplateLiteral(["hilarious comedy prop, observational glasses, Victor, the Insult Comic Hellhound Puppet"], ["hilarious comedy prop, observational glasses, Victor\\, the Insult Comic Hellhound Puppet"])))
      },
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("panda comedy insult; panda comedy observe")
    }, {
      name: "Sven Golly",
      ready: () => backstageItemsDone(),
      completed: () => lib_have($skill(_templateObject155 || (_templateObject155 = greyyou_taggedTemplateLiteral(["Liver of Steel"])))) || lib_have(template_string_$item(_templateObject156 || (_templateObject156 = greyyou_taggedTemplateLiteral(["steel margarita"])))) || lib_have(template_string_$item(_templateObject157 || (_templateObject157 = greyyou_taggedTemplateLiteral(["Azazel's unicorn"])))),
      do: () => {
        (0,external_kolmafia_namespaceObject.cliExecute)("panda arena Bognort ".concat(template_string_$items(_templateObject158 || (_templateObject158 = greyyou_taggedTemplateLiteral(["giant marshmallow, gin-soaked blotter paper"]))).find(a => lib_have(a))));
        (0,external_kolmafia_namespaceObject.cliExecute)("panda arena Stinkface ".concat(template_string_$items(_templateObject159 || (_templateObject159 = greyyou_taggedTemplateLiteral(["beer-scented teddy bear, gin-soaked blotter paper"]))).find(a => lib_have(a))));
        (0,external_kolmafia_namespaceObject.cliExecute)("panda arena Flargwurm ".concat(template_string_$items(_templateObject160 || (_templateObject160 = greyyou_taggedTemplateLiteral(["booze-soaked cherry, sponge cake"]))).find(a => lib_have(a))));
        (0,external_kolmafia_namespaceObject.cliExecute)("panda arena Jim ".concat(template_string_$items(_templateObject161 || (_templateObject161 = greyyou_taggedTemplateLiteral(["comfy pillow, sponge cake"]))).find(a => lib_have(a))));
      }
    }, {
      name: "Moaning Panda",
      ready: () => haveAll(template_string_$items(_templateObject162 || (_templateObject162 = greyyou_taggedTemplateLiteral(["Azazel's lollipop, Azazel's unicorn"])))),
      completed: () => lib_have($skill(_templateObject163 || (_templateObject163 = greyyou_taggedTemplateLiteral(["Liver of Steel"])))) || lib_have(template_string_$item(_templateObject164 || (_templateObject164 = greyyou_taggedTemplateLiteral(["steel margarita"])))) || lib_have(template_string_$item(_templateObject165 || (_templateObject165 = greyyou_taggedTemplateLiteral(["Azazel's tutu"])))),
      acquire: () => template_string_$items(_templateObject166 || (_templateObject166 = greyyou_taggedTemplateLiteral(["bus pass, imp air"]))).map(it => ({
        item: it,
        num: 5,
      ...
      completed: () => (0,external_kolmafia_namespaceObject.myAdventures)() <= 40 || (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject167 || (_templateObject167 = greyyou_taggedTemplateLiteral(["Grey Goo"]))),
      do: $location(_templateObject168 || (_templateObject168 = greyyou_taggedTemplateLiteral(["Barf Mountain"]))),
      prepare: () => {
        if (lib_have(template_string_$item(_templateObject169 || (_templateObject169 = greyyou_taggedTemplateLiteral(["How to Avoid Scams"]))))) ensureEffect($effect(_templateObject170 || (_templateObject170 = greyyou_taggedTemplateLiteral(["How to Scam Tourists"]))));
        (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject171 || (_templateObject171 = greyyou_taggedTemplateLiteral(["seal tooth"]))));
        (0,external_kolmafia_namespaceObject.restoreHp)(0.75 * (0,external_kolmafia_namespaceObject.myMaxhp)());
        (0,external_kolmafia_namespaceObject.restoreMp)(20);
      },
      outfit: () => ({
      ...
      combat: new CombatStrategy().macro(Macro.skill($skill(_templateObject172 || (_templateObject172 = greyyou_taggedTemplateLiteral(["Infinite Loop"])))), getTodaysHolidayWanderers()).macro(Macro.trySkill($skill(_templateObject173 || (_templateObject173 = greyyou_taggedTemplateLiteral(["Bowl Straight Up"])))).trySkill($skill(_templateObject174 || (_templateObject174 = greyyou_taggedTemplateLiteral(["Sing Along"])))).trySkill($skill(_templateObject175 || (_templateObject175 = greyyou_taggedTemplateLiteral(["Extract Jelly"])))).tryItem(template_string_$item(_templateObject176 || (_templateObject176 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).tryItem(template_string_$item(_templateObject177 || (_templateObject177 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject178 || (_templateObject178 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject179 || (_templateObject179 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject180 || (_templateObject180 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject181 || (_templateObject181 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject182 || (_templateObject182 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject183 || (_templateObject183 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject184 || (_templateObject184 = greyyou_taggedTemplateLiteral(["seal tooth"])))).trySkill($skill(_templateObject185 || (_templateObject185 = greyyou_taggedTemplateLiteral(["Double Nanovision"])))).attack().repeat()),
      limit: {
        tries: 150
      },
      tracking: "GooFarming"
      ...
      acquire: template_string_$items(_templateObject186 || (_templateObject186 = greyyou_taggedTemplateLiteral(["oil cap, \"DRINK ME\" potion"]))).map(it => ({
        item: it,
        price: 1000
      })),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("hatter ".concat(template_string_$item(_templateObject187 || (_templateObject187 = greyyou_taggedTemplateLiteral(["oil cap"])))))
    }, {
      name: "Free King",
      completed: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject188 || (_templateObject188 = greyyou_taggedTemplateLiteral(["Grey Goo"]))),
      acquire: () => [{
        item: template_string_$item(_templateObject189 || (_templateObject189 = greyyou_taggedTemplateLiteral(["teacher's pen"]))),
        num: 3,
        price: 500
      }].concat(greyyou_toConsumableArray(targetClass(false).primestat === $stat(_templateObject190 || (_templateObject190 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? template_string_$items(_templateObject191 || (_templateObject191 = greyyou_taggedTemplateLiteral(["discarded swimming trunks, battered hubcap, trench coat"]))).map(it => ({
        item: it
      })) : []), greyyou_toConsumableArray(targetClass(false).primestat === $stat(_templateObject192 || (_templateObject192 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? [] //$items``.map((it) => ({ item: it }))
      : []), greyyou_toConsumableArray(targetClass(false).primestat === $stat(_templateObject193 || (_templateObject193 = greyyou_taggedTemplateLiteral(["Moxie"]))) ? template_string_$items(_templateObject194 || (_templateObject194 = greyyou_taggedTemplateLiteral(["noir fedora, KoL Con 13 T-shirt"]))).map(it => ({
        item: it
      })) : [])),
      outfit: () => ({
        familiar: template_string_$familiar(_templateObject195 || (_templateObject195 = greyyou_taggedTemplateLiteral(["Grey Goose"]))),
        hat: template_string_$item(_templateObject196 || (_templateObject196 = greyyou_taggedTemplateLiteral(["giant yellow hat"]))),
        weapon: template_string_$item(_templateObject197 || (_templateObject197 = greyyou_taggedTemplateLiteral(["yule hatchet"]))),
        acc1: template_string_$item(_templateObject198 || (_templateObject198 = greyyou_taggedTemplateLiteral(["teacher's pen"]))),
        acc2: template_string_$item(_templateObject199 || (_templateObject199 = greyyou_taggedTemplateLiteral(["teacher's pen"]))),
        acc3: template_string_$item(_templateObject200 || (_templateObject200 = greyyou_taggedTemplateLiteral(["teacher's pen"]))),
        famequip: template_string_$item(_templateObject201 || (_templateObject201 = greyyou_taggedTemplateLiteral(["grey down vest"])))
      }),
      prepare: () => {
      ...
      do: () => {
        ...
        if ((0,external_kolmafia_namespaceObject.closetAmount)(template_string_$item(_templateObject202 || (_templateObject202 = greyyou_taggedTemplateLiteral(["Special Seasoning"])))) > 0) (0,external_kolmafia_namespaceObject.cliExecute)("closet take * special seasoning");
        (0,external_kolmafia_namespaceObject.print)("Grey Goose exp at prism break: ".concat(template_string_$familiar(_templateObject203 || (_templateObject203 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience, "/400"));
      }
    }, {
      name: "Call Buffy",
      completed: () => 0 !== (0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject204 || (_templateObject204 = greyyou_taggedTemplateLiteral(["Ghostly Shell"])))) || (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel,
      prepare: () => $effects(_templateObject205 || (_templateObject205 = greyyou_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation, The Sonata of Sneakiness, Polka of Plenty, Fat Leon's Phat Loot Lyric"]))).forEach(ef => (0,external_kolmafia_namespaceObject.cliExecute)("uneffect ".concat(ef))),
      do: () => {
      ...
      name: "April Shower",
      completed: () => !lib_have(template_string_$item(_templateObject206 || (_templateObject206 = greyyou_taggedTemplateLiteral(["Clan VIP Lounge key"])))) || property_get("_aprilShower"),
      ...
      completed: () => !lib_have(template_string_$item(_templateObject207 || (_templateObject207 = greyyou_taggedTemplateLiteral(["defective Game Grid token"])))) || property_get("_defectiveTokenUsed"),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject208 || (_templateObject208 = greyyou_taggedTemplateLiteral(["defective Game Grid token"]))))
    }, {
      name: "Campaway",
      ...
      do: $location(_templateObject209 || (_templateObject209 = greyyou_taggedTemplateLiteral(["The Neverending Party"])))
    }, {
      name: "NEP Exp Buff",
      ready: () => property_get("neverendingPartyAlways") && property_get("_questPartyFair") !== "unstarted" && lib_have(template_string_$item(_templateObject210 || (_templateObject210 = greyyou_taggedTemplateLiteral(["Clara's bell"])))),
      completed: () => property_get("_claraBellUsed"),
      choices: {
        1324: () => (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject211 || (_templateObject211 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? 2 : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject212 || (_templateObject212 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? 1 : 4,
        1325: 2,
        // Myst Exp %
        1326: 2,
        // Mus Exp %
      ...
      prepare: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject213 || (_templateObject213 = greyyou_taggedTemplateLiteral(["Clara's bell"])))),
      do: $location(_templateObject214 || (_templateObject214 = greyyou_taggedTemplateLiteral(["The Neverending Party"])))
    }, {
      name: "Snapper Spleen Exp %",
      completed: () => (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel || $effects(_templateObject215 || (_templateObject215 = greyyou_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).reduce((a, ef) => a || lib_have(ef), false) || (0,external_kolmafia_namespaceObject.mySpleenUse)() >= (0,external_kolmafia_namespaceObject.spleenLimit)() + 3 - property_get("currentMojoFilters"),
      do: () => {
        switch ((0,external_kolmafia_namespaceObject.myPrimestat)()) {
          case $stat(_templateObject216 || (_templateObject216 = greyyou_taggedTemplateLiteral(["Muscle"]))):
            chewOrWish(template_string_$item(_templateObject217 || (_templateObject217 = greyyou_taggedTemplateLiteral(["vial of humanoid growth hormone"]))), $effect(_templateObject218 || (_templateObject218 = greyyou_taggedTemplateLiteral(["HGH-charged"]))));
            break;

          case $stat(_templateObject219 || (_templateObject219 = greyyou_taggedTemplateLiteral(["Mysticality"]))):
            chewOrWish(template_string_$item(_templateObject220 || (_templateObject220 = greyyou_taggedTemplateLiteral(["non-Euclidean angle"]))), $effect(_templateObject221 || (_templateObject221 = greyyou_taggedTemplateLiteral(["Different Way of Seeing Things"]))));
            break;

          case $stat(_templateObject222 || (_templateObject222 = greyyou_taggedTemplateLiteral(["Moxie"]))):
            chewOrWish(template_string_$item(_templateObject223 || (_templateObject223 = greyyou_taggedTemplateLiteral(["Shantix\u2122"]))), $effect(_templateObject224 || (_templateObject224 = greyyou_taggedTemplateLiteral(["Thou Shant Not Sing"]))));
        }
      },
      limit: {
      ...
      completed: () => (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel || (0,external_kolmafia_namespaceObject.myClass)().primestat !== $stat(_templateObject225 || (_templateObject225 = greyyou_taggedTemplateLiteral(["Mysticality"]))) || lib_have($effect(_templateObject226 || (_templateObject226 = greyyou_taggedTemplateLiteral(["Inscrutable Gaze"])))) || !lib_have($skill(_templateObject227 || (_templateObject227 = greyyou_taggedTemplateLiteral(["Inscrutable Gaze"])))),
      do: () => (0,external_kolmafia_namespaceObject.useSkill)($skill(_templateObject228 || (_templateObject228 = greyyou_taggedTemplateLiteral(["Inscrutable Gaze"])))),
      limit: {
      ...
      name: "Abstraction",
      completed: () => (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel || $effects(_templateObject229 || (_templateObject229 = greyyou_taggedTemplateLiteral(["Purpose, Category, Perception"]))).reduce((a, ef) => a || lib_have(ef), false) || (0,external_kolmafia_namespaceObject.mySpleenUse)() >= (0,external_kolmafia_namespaceObject.spleenLimit)() + 3 - property_get("currentMojoFilters"),
      do: () => {
        if ((0,external_kolmafia_namespaceObject.mySpleenUse)() === (0,external_kolmafia_namespaceObject.spleenLimit)()) (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject230 || (_templateObject230 = greyyou_taggedTemplateLiteral(["mojo filter"]))));
        (0,external_kolmafia_namespaceObject.chew)(1, (0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(_templateObject231 || (_templateObject231 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? template_string_$item(_templateObject232 || (_templateObject232 = greyyou_taggedTemplateLiteral(["abstraction: purpose"]))) : (0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(_templateObject233 || (_templateObject233 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? template_string_$item(_templateObject234 || (_templateObject234 = greyyou_taggedTemplateLiteral(["abstraction: category"]))) : template_string_$item(_templateObject235 || (_templateObject235 = greyyou_taggedTemplateLiteral(["abstraction: perception"]))));
      },
      limit: {
      ...
      name: "Frobozz",
      completed: () => (0,external_kolmafia_namespaceObject.getDwelling)() === template_string_$item(_templateObject236 || (_templateObject236 = greyyou_taggedTemplateLiteral(["Frobozz Real-Estate Company Instant House (TM)"]))),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject237 || (_templateObject237 = greyyou_taggedTemplateLiteral(["Frobozz Real-Estate Company Instant House (TM)"]))))
    }, {
      name: "Bonerdagon Chest",
      completed: () => !lib_have(template_string_$item(_templateObject238 || (_templateObject238 = greyyou_taggedTemplateLiteral(["chest of the Bonerdagon"])))),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject239 || (_templateObject239 = greyyou_taggedTemplateLiteral(["chest of the Bonerdagon"]))))
    }, {
      name: "Bastille Battalion",
      ready: () => lib_have(template_string_$item(_templateObject240 || (_templateObject240 = greyyou_taggedTemplateLiteral(["Bastille Battalion control rig"])))),
      ...
      ready: () => haveAll(template_string_$items(_templateObject241 || (_templateObject241 = greyyou_taggedTemplateLiteral(["Azazel's tutu, Azazel's lollipop, Azazel's unicorn"])))),
      completed: () => lib_have($skill(_templateObject242 || (_templateObject242 = greyyou_taggedTemplateLiteral(["Liver of Steel"])))) || lib_have(template_string_$item(_templateObject243 || (_templateObject243 = greyyou_taggedTemplateLiteral(["steel margarita"])))),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("panda temple")
    }, {
      name: "Liver of Steel",
      ready: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject244 || (_templateObject244 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && lib_have(template_string_$item(_templateObject245 || (_templateObject245 = greyyou_taggedTemplateLiteral(["steel margarita"])))) && (0,external_kolmafia_namespaceObject.myLevel)() >= 5,
      completed: () => lib_have($skill(_templateObject246 || (_templateObject246 = greyyou_taggedTemplateLiteral(["Liver of Steel"])))),
      do: () => (0,external_kolmafia_namespaceObject.drink)(1, template_string_$item(_templateObject247 || (_templateObject247 = greyyou_taggedTemplateLiteral(["steel margarita"]))))
    }, {
      name: "Taffy Effects",
      completed: () => (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel || $effects(_templateObject248 || (_templateObject248 = greyyou_taggedTemplateLiteral(["Orange Crusher, Purple Reign, Cinnamon Challenger"]))).reduce((a, ef) => a || (0,external_kolmafia_namespaceObject.haveEffect)(ef) >= 50, false),
      do: () => {
        if ((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject249 || (_templateObject249 = greyyou_taggedTemplateLiteral(["Muscle"])))) (0,external_kolmafia_namespaceObject.use)(Math.ceil((50 - (0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject250 || (_templateObject250 = greyyou_taggedTemplateLiteral(["Orange Crusher"]))))) / 10), template_string_$item(_templateObject251 || (_templateObject251 = greyyou_taggedTemplateLiteral(["pulled orange taffy"])))); //lasts for 10 turns each

        if ((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject252 || (_templateObject252 = greyyou_taggedTemplateLiteral(["Mysticality"])))) (0,external_kolmafia_namespaceObject.use)(Math.ceil((50 - (0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject253 || (_templateObject253 = greyyou_taggedTemplateLiteral(["Purple Reign"]))))) / 10), template_string_$item(_templateObject254 || (_templateObject254 = greyyou_taggedTemplateLiteral(["pulled violet taffy"])))); //lasts for 10 turns each

        if ((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject255 || (_templateObject255 = greyyou_taggedTemplateLiteral(["Moxie"])))) (0,external_kolmafia_namespaceObject.use)(Math.ceil((50 - (0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject256 || (_templateObject256 = greyyou_taggedTemplateLiteral(["Cinnamon Challenger"]))))) / 10), template_string_$item(_templateObject257 || (_templateObject257 = greyyou_taggedTemplateLiteral(["pulled red taffy"])))); //lasts for 10 turns each
      },
      limit: {
        tries: Math.ceil(levelingTurns / 10)
      },
      ...
      name: "Ghost Dog Chow",
      completed: () => (0,external_kolmafia_namespaceObject.myLevel)() >= 8 || template_string_$familiar(_templateObject258 || (_templateObject258 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience > 380,
      prepare: () => (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject259 || (_templateObject259 = greyyou_taggedTemplateLiteral(["Grey Goose"])))),
      do: () => (0,external_kolmafia_namespaceObject.use)(Math.floor((400 - template_string_$familiar(_templateObject260 || (_templateObject260 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience) / 20), template_string_$item(_templateObject261 || (_templateObject261 = greyyou_taggedTemplateLiteral(["Ghost Dog Chow"])))),
      tracking: "Leveling"
    }, {
      name: "Restore HP",
      completed: () => (0,external_kolmafia_namespaceObject.myHp)() > 0.5 * (0,external_kolmafia_namespaceObject.myMaxhp)(),
      ...
      completed: () => !lib_have($skill(_templateObject262 || (_templateObject262 = greyyou_taggedTemplateLiteral(["Blood Bubble"])))) || lib_have($effect(_templateObject263 || (_templateObject263 = greyyou_taggedTemplateLiteral(["Blood Bubble"])))) || (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel,
      do: () => (0,external_kolmafia_namespaceObject.useSkill)($skill(_templateObject264 || (_templateObject264 = greyyou_taggedTemplateLiteral(["Blood Bubble"])))),
      tracking: "Leveling"
    }, {
      name: "Implement Glitch",
      ready: () => lib_have(template_string_$item(_templateObject265 || (_templateObject265 = greyyou_taggedTemplateLiteral(["[glitch season reward name]"])))),
      completed: () => property_get("_glitchItemImplemented"),
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject266 || (_templateObject266 = greyyou_taggedTemplateLiteral(["[glitch season reward name]"]))))
    }, {
      name: "Fight Glitch",
      ready: () => lib_have(template_string_$item(_templateObject267 || (_templateObject267 = greyyou_taggedTemplateLiteral(["[glitch season reward name]"])))),
      completed: () => property_get("_glitchMonsterFights") > 0,
      acquire: template_string_$items(_templateObject268 || (_templateObject268 = greyyou_taggedTemplateLiteral(["gas can, gas balloon, shard of double-ice"]))).map(it => ({
        item: it,
        price: 1000
      })),
      ...
      combat: new CombatStrategy().macro(() => {
        ...
        return (_Macro$tryItem$extern = Macro.tryItem(template_string_$item(_templateObject269 || (_templateObject269 = greyyou_taggedTemplateLiteral(["gas balloon"])))).externalIf(lib_have($skill(_templateObject270 || (_templateObject270 = greyyou_taggedTemplateLiteral(["Feel Pride"])))) && property_get("_feelPrideUsed") < 3, Macro.trySkill($skill(_templateObject271 || (_templateObject271 = greyyou_taggedTemplateLiteral(["Feel Pride"])))))).tryItem.apply(_Macro$tryItem$extern, greyyou_toConsumableArray(template_string_$items(_templateObject272 || (_templateObject272 = greyyou_taggedTemplateLiteral(["shard of double-ice, gas can"]))))).attack().repeat();
      }),
      tracking: "Leveling"
    }, {
      name: "Drunk Pygmies",
      ready: () => !!$effects(_templateObject273 || (_templateObject273 = greyyou_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).find(ef => lib_have(ef)),
      completed: () => (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel || property_get("_drunkPygmyBanishes") >= 11 && !property_get("crystalBallPredictions").includes($monster(_templateObject274 || (_templateObject274 = greyyou_taggedTemplateLiteral(["drunk pygmy"]))).name),
      acquire: [{
        item: template_string_$item(_templateObject275 || (_templateObject275 = greyyou_taggedTemplateLiteral(["Bowl of Scorpions"]))),
        price: 1000
      }].concat(greyyou_toConsumableArray($monsters(_templateObject276 || (_templateObject276 = greyyou_taggedTemplateLiteral(["pygmy orderlies, pygmy bowler"]))).find(mob => !(0,external_kolmafia_namespaceObject.isBanished)(mob)) ? [{
        item: nextUnusedBanishItem(),
        price: 20000
      }] : [])),
      effects: $effects(_templateObject277 || (_templateObject277 = greyyou_taggedTemplateLiteral(["Heart of White"]))),
      outfit: () => greyyou_objectSpread(greyyou_objectSpread(greyyou_objectSpread(greyyou_objectSpread({
        familiar: template_string_$familiar(_templateObject278 || (_templateObject278 = greyyou_taggedTemplateLiteral(["Grey Goose"])))
      }, lib_have(template_string_$item(_templateObject279 || (_templateObject279 = greyyou_taggedTemplateLiteral(["cursed magnifying glass"])))) && template_string_$familiar(_templateObject280 || (_templateObject280 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience < 400 ? {
        offhand: template_string_$item(_templateObject281 || (_templateObject281 = greyyou_taggedTemplateLiteral(["cursed magnifying glass"])))
      } : {}), lib_have(template_string_$item(_templateObject282 || (_templateObject282 = greyyou_taggedTemplateLiteral(["miniature crystal ball"])))) && property_get("_drunkPygmyBanishes") >= 10 ? {
        famequip: template_string_$item(_templateObject283 || (_templateObject283 = greyyou_taggedTemplateLiteral(["miniature crystal ball"])))
      } : {}), lib_have(template_string_$item(_templateObject284 || (_templateObject284 = greyyou_taggedTemplateLiteral(["mafia middle finger ring"])))) && (0,external_kolmafia_namespaceObject.myBasestat)($stat(_templateObject285 || (_templateObject285 = greyyou_taggedTemplateLiteral(["Muscle"])))) >= 45 && !property_get("_mafiaMiddleFingerRingUsed") ? {
        equip: [template_string_$item(_templateObject286 || (_templateObject286 = greyyou_taggedTemplateLiteral(["mafia middle finger ring"])))]
      } : {}), {}, {
      ...
      prepare: () => {
        ...
        if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject287 || (_templateObject287 = greyyou_taggedTemplateLiteral(["bowling ball"])))) > 0) (0,external_kolmafia_namespaceObject.putCloset)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject288 || (_templateObject288 = greyyou_taggedTemplateLiteral(["bowling ball"])))), template_string_$item(_templateObject289 || (_templateObject289 = greyyou_taggedTemplateLiteral(["bowling ball"]))));
      },
      do: $location(_templateObject290 || (_templateObject290 = greyyou_taggedTemplateLiteral(["The Hidden Bowling Alley"]))),
      combat: new CombatStrategy().macro(() => Macro.externalIf(template_string_$familiar(_templateObject291 || (_templateObject291 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject292 || (_templateObject292 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject293 || (_templateObject293 = greyyou_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject294 || (_templateObject294 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject295 || (_templateObject295 = greyyou_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject296 || (_templateObject296 = greyyou_taggedTemplateLiteral(["Convert Matter to Pomade"]))))), $monsters(_templateObject297 || (_templateObject297 = greyyou_taggedTemplateLiteral(["void slab, void guy, void spider, drunk pygmy"])))).macro(() => Macro.trySkill($skill(_templateObject298 || (_templateObject298 = greyyou_taggedTemplateLiteral(["Show them your ring"])))).externalIf(lib_have($skill(_templateObject299 || (_templateObject299 = greyyou_taggedTemplateLiteral(["Snokebomb"])))) && !getBanishedMonsters().get($skill(_templateObject300 || (_templateObject300 = greyyou_taggedTemplateLiteral(["Snokebomb"])))), Macro.trySkill($skill(_templateObject301 || (_templateObject301 = greyyou_taggedTemplateLiteral(["Snokebomb"]))))).externalIf(lib_have($skill(_templateObject302 || (_templateObject302 = greyyou_taggedTemplateLiteral(["Feel Hatred"])))) && !getBanishedMonsters().get($skill(_templateObject303 || (_templateObject303 = greyyou_taggedTemplateLiteral(["Feel Hatred"])))), Macro.trySkill($skill(_templateObject304 || (_templateObject304 = greyyou_taggedTemplateLiteral(["Feel Hatred"]))))).tryItem(nextUnusedBanishItem()), $monsters(_templateObject305 || (_templateObject305 = greyyou_taggedTemplateLiteral(["pygmy bowler, pygmy orderlies, pygmy janitor"])))).macro(Macro.tryItem(template_string_$item(_templateObject306 || (_templateObject306 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).tryItem(template_string_$item(_templateObject307 || (_templateObject307 = greyyou_taggedTemplateLiteral(["spectre scepter"])))).attack().repeat()),
      limit: {
        tries: 15
      },
      tracking: "Leveling"
      ...
      name: "Ball Pit",
      completed: () => !lib_have(template_string_$item(_templateObject308 || (_templateObject308 = greyyou_taggedTemplateLiteral(["Clan VIP Lounge key"])))) || property_get("_ballpit"),
      ...
      name: "Telescope Buff",
      completed: () => !(template_string_$item(_templateObject309 || (_templateObject309 = greyyou_taggedTemplateLiteral(["Discount Telescope Warehouse gift certificate"]))).name in (0,external_kolmafia_namespaceObject.getCampground)()) || property_get("telescopeLookedHigh"),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)("telescope high"),
      tracking: "Leveling"
    }, {
      name: "Fight Seals",
      ready: () => lib_have(template_string_$item(_templateObject310 || (_templateObject310 = greyyou_taggedTemplateLiteral(["figurine of a wretched-looking seal"])))) && lib_have(template_string_$item(_templateObject311 || (_templateObject311 = greyyou_taggedTemplateLiteral(["seal-blubber candle"])))),
      completed: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject312 || (_templateObject312 = greyyou_taggedTemplateLiteral(["Seal Clubber"]))) || property_get("_sealsSummoned") >= 10 || !lib_have(template_string_$item(_templateObject313 || (_templateObject313 = greyyou_taggedTemplateLiteral(["Claw of the Infernal Seal"])))) && property_get("_sealsSummoned") >= 5,
      outfit: () => ({
        familiar: template_string_$familiar(_templateObject314 || (_templateObject314 = greyyou_taggedTemplateLiteral(["Grey Goose"]))),
      ...
      combat: new CombatStrategy().macro(() => Macro.externalIf(template_string_$familiar(_templateObject315 || (_templateObject315 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject316 || (_templateObject316 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject317 || (_templateObject317 = greyyou_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject318 || (_templateObject318 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject319 || (_templateObject319 = greyyou_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject320 || (_templateObject320 = greyyou_taggedTemplateLiteral(["Convert Matter to Pomade"]))))).trySkill($skill(_templateObject321 || (_templateObject321 = greyyou_taggedTemplateLiteral(["Sing Along"])))).tryItem(template_string_$item(_templateObject322 || (_templateObject322 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).attack().repeat()),
      limit: {
        tries: 10
      },
      tracking: "Leveling"
      ...
      // eslint-disable-next-line libram/verify-constants
      do: $location(_templateObject324 || (_templateObject324 = greyyou_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
      post: () => {
        if (!property_get("_lastCombatWon")) throw new Error("Lost Combat - Check to see what went wrong.");
      },
      combat: new CombatStrategy().macro(() => Macro.externalIf(template_string_$familiar(_templateObject325 || (_templateObject325 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject326 || (_templateObject326 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject327 || (_templateObject327 = greyyou_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject328 || (_templateObject328 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject329 || (_templateObject329 = greyyou_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject330 || (_templateObject330 = greyyou_taggedTemplateLiteral(["Convert Matter to Pomade"]))))).trySkill($skill(_templateObject331 || (_templateObject331 = greyyou_taggedTemplateLiteral(["Sing Along"])))).tryItem(template_string_$item(_templateObject332 || (_templateObject332 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(_templateObject333 || (_templateObject333 = greyyou_taggedTemplateLiteral(["Saucestorm"])))).trySkill($skill(_templateObject334 || (_templateObject334 = greyyou_taggedTemplateLiteral(["Saucestorm"])))).attack().repeat()),
      tracking: "Leveling",
      limit: {
        tries: 3
      }
      ...
      effects: $effects(_templateObject335 || (_templateObject335 = greyyou_taggedTemplateLiteral(["Trivia Master"]))),
      ...
      acquire: () => greyyou_toConsumableArray(lib_have($skill(_templateObject336 || (_templateObject336 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))) ? [] : [{
        item: template_string_$item(_templateObject337 || (_templateObject337 = greyyou_taggedTemplateLiteral(["electronics kit"]))),
        price: 500
      }]),
      outfit: () => ({
        familiar: template_string_$familiar(_templateObject338 || (_templateObject338 = greyyou_taggedTemplateLiteral(["Grey Goose"]))),
      ...
      combat: new CombatStrategy().macro(() => Macro.externalIf(lib_have($skill(_templateObject339 || (_templateObject339 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill($skill(_templateObject340 || (_templateObject340 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(_templateObject341 || (_templateObject341 = greyyou_taggedTemplateLiteral(["electronics kit"]))))).externalIf(template_string_$familiar(_templateObject342 || (_templateObject342 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject343 || (_templateObject343 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject344 || (_templateObject344 = greyyou_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject345 || (_templateObject345 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject346 || (_templateObject346 = greyyou_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject347 || (_templateObject347 = greyyou_taggedTemplateLiteral(["Convert Matter to Pomade"]))))).tryItem(template_string_$item(_templateObject348 || (_templateObject348 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(_templateObject349 || (_templateObject349 = greyyou_taggedTemplateLiteral(["Sing Along"])))).attack().repeat()),
      tracking: "Leveling"
    }, {
      name: "NEP Free Fights",
      ready: () => property_get("neverendingPartyAlways") && !!$effects(_templateObject350 || (_templateObject350 = greyyou_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).find(ef => lib_have(ef)),
      completed: () => property_get("_neverendingPartyFreeTurns") >= 10 || (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject351 || (_templateObject351 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel,
      effects: $effects(_templateObject352 || (_templateObject352 = greyyou_taggedTemplateLiteral(["Heart of White"]))),
      acquire: () => [].concat(greyyou_toConsumableArray(lib_have($skill(_templateObject353 || (_templateObject353 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))) ? [] : [{
        item: template_string_$item(_templateObject354 || (_templateObject354 = greyyou_taggedTemplateLiteral(["electronics kit"]))),
        price: 500
      }]), greyyou_toConsumableArray(lib_have(template_string_$item(_templateObject355 || (_templateObject355 = greyyou_taggedTemplateLiteral(["January's Garbage Tote"])))) ? [{
        item: template_string_$item(_templateObject356 || (_templateObject356 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))
      }] : [])),
      outfit: () => greyyou_objectSpread(greyyou_objectSpread({
        familiar: template_string_$familiar(_templateObject357 || (_templateObject357 = greyyou_taggedTemplateLiteral(["Grey Goose"])))
      }, lib_have(template_string_$item(_templateObject358 || (_templateObject358 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))) ? {
        shirt: template_string_$item(_templateObject359 || (_templateObject359 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))
      } : {}), {}, {
        modifier: "0.125 ".concat((0,external_kolmafia_namespaceObject.myPrimestat)(), ", ").concat((0,external_kolmafia_namespaceObject.myPrimestat)(), " experience, 5 ").concat((0,external_kolmafia_namespaceObject.myPrimestat)(), " experience percent, 10 familiar experience, ").concat(noML())
      }),
      prepare: () => {
      ...
      do: $location(_templateObject360 || (_templateObject360 = greyyou_taggedTemplateLiteral(["The Neverending Party"]))),
      post: () => {
        if (!property_get("_lastCombatWon")) throw new Error("Lost Combat - Check to see what went wrong.");
      },
      choices: {
      ...
      combat: new CombatStrategy().macro(() => {
        ...
        return (_Macro$step$externalI = Macro.step("pickpocket").externalIf(lib_have($skill(_templateObject361 || (_templateObject361 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill($skill(_templateObject362 || (_templateObject362 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(_templateObject363 || (_templateObject363 = greyyou_taggedTemplateLiteral(["electronics kit"]))))).externalIf(template_string_$familiar(_templateObject364 || (_templateObject364 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject365 || (_templateObject365 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject366 || (_templateObject366 = greyyou_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject367 || (_templateObject367 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject368 || (_templateObject368 = greyyou_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject369 || (_templateObject369 = greyyou_taggedTemplateLiteral(["Convert Matter to Pomade"])))))).tryItem.apply(_Macro$step$externalI, greyyou_toConsumableArray(template_string_$items(_templateObject370 || (_templateObject370 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun, HOA citation pad"]))))).trySkill($skill(_templateObject371 || (_templateObject371 = greyyou_taggedTemplateLiteral(["Sing Along"])))).attack().repeat();
      }),
      limit: {
        tries: 13
      },
      ...
      name: "Gators",
      ready: () => !!$effects(_templateObject372 || (_templateObject372 = greyyou_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).find(ef => lib_have(ef)),
      completed: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject373 || (_templateObject373 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myLevel)() >= args.targetlevel,
      effects: $effects(_templateObject374 || (_templateObject374 = greyyou_taggedTemplateLiteral(["Heart of White, Expert Vacationer"]))),
      acquire: () => [].concat(greyyou_toConsumableArray(lib_have($skill(_templateObject375 || (_templateObject375 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))) ? [] : [{
        item: template_string_$item(_templateObject376 || (_templateObject376 = greyyou_taggedTemplateLiteral(["electronics kit"]))),
        price: 500
      }]), greyyou_toConsumableArray(lib_have(template_string_$item(_templateObject377 || (_templateObject377 = greyyou_taggedTemplateLiteral(["January's Garbage Tote"])))) ? [{
        item: template_string_$item(_templateObject378 || (_templateObject378 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))
      }] : [])),
      outfit: () => greyyou_objectSpread(greyyou_objectSpread(greyyou_objectSpread({
        familiar: template_string_$familiar(_templateObject379 || (_templateObject379 = greyyou_taggedTemplateLiteral(["Grey Goose"])))
      }, lib_have(template_string_$item(_templateObject380 || (_templateObject380 = greyyou_taggedTemplateLiteral(["The Jokester's gun"])))) && (0,external_kolmafia_namespaceObject.myBasestat)($stat(_templateObject381 || (_templateObject381 = greyyou_taggedTemplateLiteral(["Moxie"])))) >= 50 && !property_get("_firedJokestersGun") ? {
        weapon: template_string_$item(_templateObject382 || (_templateObject382 = greyyou_taggedTemplateLiteral(["The Jokester's gun"])))
      } : lib_have(template_string_$item(_templateObject383 || (_templateObject383 = greyyou_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) && property_get("_chestXRayUsed") < 3 ? {
        equip: [template_string_$item(_templateObject384 || (_templateObject384 = greyyou_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))]
      } : {}), lib_have(template_string_$item(_templateObject385 || (_templateObject385 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))) ? {
        shirt: template_string_$item(_templateObject386 || (_templateObject386 = greyyou_taggedTemplateLiteral(["makeshift garbage shirt"])))
      } : {}), {}, {
        modifier: "0.125 ".concat((0,external_kolmafia_namespaceObject.myPrimestat)(), ", ").concat((0,external_kolmafia_namespaceObject.myPrimestat)(), " experience, 5 ").concat((0,external_kolmafia_namespaceObject.myPrimestat)(), " experience percent, 10 familiar experience, ").concat(noML())
      }),
      prepare: () => {
      ...
      do: $location(_templateObject387 || (_templateObject387 = greyyou_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))),
      post: () => {
        if (!property_get("_lastCombatWon")) throw new Error("Lost Combat - Check to see what went wrong.");
      },
      combat: new CombatStrategy().macro(() => Macro.step("pickpocket").externalIf(lib_have($skill(_templateObject388 || (_templateObject388 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.trySkill($skill(_templateObject389 || (_templateObject389 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))), Macro.tryItem(template_string_$item(_templateObject390 || (_templateObject390 = greyyou_taggedTemplateLiteral(["electronics kit"]))))).externalIf(template_string_$familiar(_templateObject391 || (_templateObject391 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject392 || (_templateObject392 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? $skill(_templateObject393 || (_templateObject393 = greyyou_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject394 || (_templateObject394 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? $skill(_templateObject395 || (_templateObject395 = greyyou_taggedTemplateLiteral(["Convert Matter to Energy"]))) : $skill(_templateObject396 || (_templateObject396 = greyyou_taggedTemplateLiteral(["Convert Matter to Pomade"]))))).tryItem(template_string_$item(_templateObject397 || (_templateObject397 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill($skill(_templateObject398 || (_templateObject398 = greyyou_taggedTemplateLiteral(["Sing Along"])))).trySkill($skill(_templateObject399 || (_templateObject399 = greyyou_taggedTemplateLiteral(["Fire the Jokester's Gun"])))).trySkill($skill(_templateObject400 || (_templateObject400 = greyyou_taggedTemplateLiteral(["Chest X-Ray"])))).trySkill($skill(_templateObject401 || (_templateObject401 = greyyou_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill($skill(_templateObject402 || (_templateObject402 = greyyou_taggedTemplateLiteral(["Shattering Punch"])))).attack().repeat()),
      limit: {
      ...
      completed: () => !lib_have($skill(_templateObject403 || (_templateObject403 = greyyou_taggedTemplateLiteral(["Comprehensive Cartography"])))) || (0,external_kolmafia_namespaceObject.myAscensions)() === property_get("lastCartographyBooPeak"),
      choices: {
        1430: 3,
        606: 4,
        610: 1,
      ...
      do: $location(_templateObject404 || (_templateObject404 = greyyou_taggedTemplateLiteral(["A-Boo Peak"]))),
      outfit: {
      ...
      prepare: () => uneffect($effect(_templateObject405 || (_templateObject405 = greyyou_taggedTemplateLiteral(["Beaten Up"])))),
      do: () => (0,external_kolmafia_namespaceObject.cliExecute)(args.garbo),
      post: () => $effects(_templateObject406 || (_templateObject406 = greyyou_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => lib_have(ef)).forEach(ef => uneffect(ef)),
      tracking: "Garbo"
    }, {
      name: "Turn in FunFunds",
      ready: () => property_get("_stenchAirportToday") && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject407 || (_templateObject407 = greyyou_taggedTemplateLiteral(["FunFunds\u2122"])))) >= 20,
      completed: () => lib_have(template_string_$item(_templateObject408 || (_templateObject408 = greyyou_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      do: () => (0,external_kolmafia_namespaceObject.buy)($coinmaster(_templateObject409 || (_templateObject409 = greyyou_taggedTemplateLiteral(["The Dinsey Company Store"]))), 1, template_string_$item(_templateObject410 || (_templateObject410 = greyyou_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
      tracking: "Garbo"
    }, {
      name: "PvP",
      ...
      name: "Stooper",
      ready: () => (0,external_kolmafia_namespaceObject.myInebriety)() === (0,external_kolmafia_namespaceObject.inebrietyLimit)() && lib_have(template_string_$item(_templateObject411 || (_templateObject411 = greyyou_taggedTemplateLiteral(["tiny stillsuit"])))) && property_get("familiarSweat") >= 300,
      completed: () => !lib_have(template_string_$familiar(_templateObject412 || (_templateObject412 = greyyou_taggedTemplateLiteral(["Stooper"])))) || stooperDrunk(),
      do: () => {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject413 || (_templateObject413 = greyyou_taggedTemplateLiteral(["Stooper"]))));
        (0,external_kolmafia_namespaceObject.cliExecute)("drink stillsuit distillate");
      }
    }, {
      name: "Nightcap",
      ...
      name: "Pajamas",
      completed: () => (0,external_kolmafia_namespaceObject.getCampground)()[template_string_$item(_templateObject414 || (_templateObject414 = greyyou_taggedTemplateLiteral(["clockwork maid"]))).name] === 1,
      acquire: [{
        item: template_string_$item(_templateObject415 || (_templateObject415 = greyyou_taggedTemplateLiteral(["clockwork maid"]))),
        price: 7 * property_get("valueOfAdventure")
      }, {
        item: template_string_$item(_templateObject416 || (_templateObject416 = greyyou_taggedTemplateLiteral(["burning cape"])))
      }],
      do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject417 || (_templateObject417 = greyyou_taggedTemplateLiteral(["clockwork maid"])))),
      outfit: () => ({
        familiar: $familiars(_templateObject418 || (_templateObject418 = greyyou_taggedTemplateLiteral(["Trick-or-Treating Tot, Left-Hand Man, Disembodied Hand, Grey Goose"]))).find(fam => lib_have(fam)),
        modifier: "adventures".concat(args.pvp ? ", 0.3 fites" : "")
      })
    }, {
      name: "Summon Soap Knife",
      completed: () => !lib_have($skill(_templateObject419 || (_templateObject419 = greyyou_taggedTemplateLiteral(["That's Not a Knife"])))) || property_get("_discoKnife"),
      prepare: () => (0,external_kolmafia_namespaceObject.putCloset)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject420 || (_templateObject420 = greyyou_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject421 || (_templateObject421 = greyyou_taggedTemplateLiteral(["soap knife"])))),
      do: () => (0,external_kolmafia_namespaceObject.useSkill)($skill(_templateObject422 || (_templateObject422 = greyyou_taggedTemplateLiteral(["That's Not a Knife"])))),
      post: () => (0,external_kolmafia_namespaceObject.takeCloset)((0,external_kolmafia_namespaceObject.closetAmount)(template_string_$item(_templateObject423 || (_templateObject423 = greyyou_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject424 || (_templateObject424 = greyyou_taggedTemplateLiteral(["soap knife"]))))
    }, {
      name: "Tip the Author",
      //disabled by default - must manually discover and enable the flag
      ready: () => args.tip,
      completed: () => !lib_have(template_string_$item(_templateObject425 || (_templateObject425 = greyyou_taggedTemplateLiteral(["soap knife"])))),
