...
var GyouQuest = {
  ...
  tasks: [{
    ...
    outfit: {
      weapon: template_string_$item(_templateObject81 || (_templateObject81 = greyyou_taggedTemplateLiteral(["none"]))),
      equip: template_string_$items(_templateObject82 || (_templateObject82 = greyyou_taggedTemplateLiteral(["observational glasses, Victor, the Insult Comic Hellhound Puppet"], ["observational glasses, Victor\\, the Insult Comic Hellhound Puppet"])))
    },
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("panda comedy insult; panda comedy observe")
  }, {
    name: "Sven Golly",
    ready: () => backstageItemsDone(),
    completed: () => have(template_string_$skill(_templateObject83 || (_templateObject83 = greyyou_taggedTemplateLiteral(["Liver of Steel"])))) || have(template_string_$item(_templateObject84 || (_templateObject84 = greyyou_taggedTemplateLiteral(["steel margarita"])))) || have(template_string_$item(_templateObject85 || (_templateObject85 = greyyou_taggedTemplateLiteral(["Azazel's unicorn"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.cliExecute)("panda arena Bognort ".concat(template_string_$items(_templateObject86 || (_templateObject86 = greyyou_taggedTemplateLiteral(["giant marshmallow, gin-soaked blotter paper"]))).find(a => have(a))));
      (0,external_kolmafia_namespaceObject.cliExecute)("panda arena Stinkface ".concat(template_string_$items(_templateObject87 || (_templateObject87 = greyyou_taggedTemplateLiteral(["beer-scented teddy bear, gin-soaked blotter paper"]))).find(a => have(a))));
      (0,external_kolmafia_namespaceObject.cliExecute)("panda arena Flargwurm ".concat(template_string_$items(_templateObject88 || (_templateObject88 = greyyou_taggedTemplateLiteral(["booze-soaked cherry, sponge cake"]))).find(a => have(a))));
      (0,external_kolmafia_namespaceObject.cliExecute)("panda arena Jim ".concat(template_string_$items(_templateObject89 || (_templateObject89 = greyyou_taggedTemplateLiteral(["comfy pillow, sponge cake"]))).find(a => have(a))));
    }
  }, {
    name: "Moaning Panda",
    ...
    completed: () => have(template_string_$skill(_templateObject91 || (_templateObject91 = greyyou_taggedTemplateLiteral(["Liver of Steel"])))) || have(template_string_$item(_templateObject92 || (_templateObject92 = greyyou_taggedTemplateLiteral(["steel margarita"])))) || have(template_string_$item(_templateObject93 || (_templateObject93 = greyyou_taggedTemplateLiteral(["Azazel's tutu"])))),
    ...
    completed: () => (0,external_kolmafia_namespaceObject.myAdventures)() <= 40 || (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject95 || (_templateObject95 = greyyou_taggedTemplateLiteral(["Grey Goo"]))),
    do: $location(_templateObject96 || (_templateObject96 = greyyou_taggedTemplateLiteral(["Barf Mountain"]))),
    prepare: () => {
      if (have(template_string_$item(_templateObject97 || (_templateObject97 = greyyou_taggedTemplateLiteral(["How to Avoid Scams"]))))) ensureEffect($effect(_templateObject98 || (_templateObject98 = greyyou_taggedTemplateLiteral(["How to Scam Tourists"]))));
      (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(_templateObject99 || (_templateObject99 = greyyou_taggedTemplateLiteral(["seal tooth"]))));
      if (have(template_string_$item(_templateObject100 || (_templateObject100 = greyyou_taggedTemplateLiteral(["SongBoom\u2122 BoomBox"])))) && property_get("boomBoxSong") !== "Total Eclipse of Your Meat") (0,external_kolmafia_namespaceObject.cliExecute)("boombox meat");
      (0,external_kolmafia_namespaceObject.restoreHp)(0.75 * (0,external_kolmafia_namespaceObject.myMaxhp)());
      (0,external_kolmafia_namespaceObject.restoreMp)(20);
    },
    outfit: {
      familiar: $familiars(_templateObject101 || (_templateObject101 = greyyou_taggedTemplateLiteral(["Space Jellyfish, Robortender, Hobo Monkey, Leprechaun"]))).find(f => have(f)),
      modifier: "2.5 meat, 0.6 items, 750 bonus lucky gold ring, 250 bonus Mr. Cheeng's spectacles, 250 bonus mafia thumb ring"
    },
    combat: new CombatStrategy().macro(structure_Macro.step("if pastround 2; abort Macro did not complete; endif;").trySkill(template_string_$skill(_templateObject102 || (_templateObject102 = greyyou_taggedTemplateLiteral(["Bowl Straight Up"])))).trySkill(template_string_$skill(_templateObject103 || (_templateObject103 = greyyou_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject104 || (_templateObject104 = greyyou_taggedTemplateLiteral(["Extract Jelly"])))).tryItem(template_string_$item(_templateObject105 || (_templateObject105 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).tryItem(template_string_$item(_templateObject106 || (_templateObject106 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject107 || (_templateObject107 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject108 || (_templateObject108 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject109 || (_templateObject109 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject110 || (_templateObject110 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject111 || (_templateObject111 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject112 || (_templateObject112 = greyyou_taggedTemplateLiteral(["seal tooth"])))).tryItem(template_string_$item(_templateObject113 || (_templateObject113 = greyyou_taggedTemplateLiteral(["seal tooth"])))).trySkill(template_string_$skill(_templateObject114 || (_templateObject114 = greyyou_taggedTemplateLiteral(["Double Nanovision"])))).attack().repeat().setAutoAttack()),
    limit: {
      tries: 150
    },
    tracking: "GooFarming"
    ...
    acquire: template_string_$items(_templateObject115 || (_templateObject115 = greyyou_taggedTemplateLiteral(["oil cap, \"DRINK ME\" potion"]))).map(it => ({
      item: it
    })),
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("hatter ".concat(template_string_$item(_templateObject116 || (_templateObject116 = greyyou_taggedTemplateLiteral(["oil cap"])))))
  }, {
    name: "Free King",
    completed: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject117 || (_templateObject117 = greyyou_taggedTemplateLiteral(["Grey Goo"]))),
    acquire: () => [{
      item: template_string_$item(_templateObject118 || (_templateObject118 = greyyou_taggedTemplateLiteral(["teacher's pen"]))),
      num: 3
    }].concat(greyyou_toConsumableArray(targetClass(false).primestat === $stat(_templateObject119 || (_templateObject119 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? template_string_$items(_templateObject120 || (_templateObject120 = greyyou_taggedTemplateLiteral(["discarded swimming trunks, battered hubcap, trench coat"]))).map(it => ({
      item: it
    })) : []), greyyou_toConsumableArray(targetClass(false).primestat === $stat(_templateObject121 || (_templateObject121 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? [] //$items``.map((it) => ({ item: it }))
    ...
    name: "Gators",
    ready: () => !!$effects(_templateObject179 || (_templateObject179 = greyyou_taggedTemplateLiteral(["HGH-charged, Different Way of Seeing Things, Thou Shant Not Sing"]))).find(ef => have(ef)),
    completed: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject180 || (_templateObject180 = greyyou_taggedTemplateLiteral(["Grey Goo"]))) && (0,external_kolmafia_namespaceObject.myLevel)() >= targetLevel,
    effects: $effects(_templateObject181 || (_templateObject181 = greyyou_taggedTemplateLiteral(["Heart of White, Expert Vacationer"]))),
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(0.75 * (0,external_kolmafia_namespaceObject.myMaxhp)());
      (0,external_kolmafia_namespaceObject.restoreMp)(8);
    },
    do: $location(_templateObject182 || (_templateObject182 = greyyou_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))),
    outfit: () => ({
      familiar: template_string_$familiar(_templateObject183 || (_templateObject183 = greyyou_taggedTemplateLiteral(["Grey Goose"]))),
    ...
    combat: new CombatStrategy().macro(() => structure_Macro.step("if pastround 2; abort Macro did not complete; endif;").trySkill(template_string_$skill(_templateObject184 || (_templateObject184 = greyyou_taggedTemplateLiteral(["Curse of Weaksauce"])))).externalIf(template_string_$familiar(_templateObject185 || (_templateObject185 = greyyou_taggedTemplateLiteral(["Grey Goose"]))).experience >= 400, structure_Macro.trySkill((0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject186 || (_templateObject186 = greyyou_taggedTemplateLiteral(["Muscle"]))) ? template_string_$skill(_templateObject187 || (_templateObject187 = greyyou_taggedTemplateLiteral(["Convert Matter to Protein"]))) : (0,external_kolmafia_namespaceObject.myPrimestat)() === $stat(_templateObject188 || (_templateObject188 = greyyou_taggedTemplateLiteral(["Mysticality"]))) ? template_string_$skill(_templateObject189 || (_templateObject189 = greyyou_taggedTemplateLiteral(["Convert Matter to Energy"]))) : template_string_$skill(_templateObject190 || (_templateObject190 = greyyou_taggedTemplateLiteral(["Convert Matter to Pomade"]))))).tryItem(template_string_$item(_templateObject191 || (_templateObject191 = greyyou_taggedTemplateLiteral(["porquoise-handled sixgun"])))).trySkill(template_string_$skill(_templateObject192 || (_templateObject192 = greyyou_taggedTemplateLiteral(["Sing Along"])))).attack().repeat().setAutoAttack()),
    limit: {
    ...
    post: () => $effects(_templateObject194 || (_templateObject194 = greyyou_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(ef => have(ef)).forEach(ef => uneffect(ef)),
    tracking: "Garbo"
  }, {
    name: "Turn in FunFunds",
    ready: () => property_get("_stenchAirportToday") && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject195 || (_templateObject195 = greyyou_taggedTemplateLiteral(["FunFunds\u2122"])))) >= 20,
    completed: () => have(template_string_$item(_templateObject196 || (_templateObject196 = greyyou_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
    do: () => (0,external_kolmafia_namespaceObject.buy)($coinmaster(_templateObject197 || (_templateObject197 = greyyou_taggedTemplateLiteral(["The Dinsey Company Store"]))), 1, template_string_$item(_templateObject198 || (_templateObject198 = greyyou_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))),
    tracking: "Garbo"
  }, {
    name: "PvP",
    ready: () => readyForBed(),
    ...
    name: "Pajamas",
    completed: () => (0,external_kolmafia_namespaceObject.getCampground)()[template_string_$item(_templateObject199 || (_templateObject199 = greyyou_taggedTemplateLiteral(["clockwork maid"]))).name] === 1,
    do: () => {
      ...
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject200 || (_templateObject200 = greyyou_taggedTemplateLiteral(["clockwork maid"]))));
    }
  }, {
    name: "Nightcap",
    ready: () => readyForBed(),
    ...
    name: "Summon Soap Knife",
    completed: () => !have(template_string_$skill(_templateObject201 || (_templateObject201 = greyyou_taggedTemplateLiteral(["That's Not a Knife"])))) || property_get("_discoKnife"),
    prepare: () => (0,external_kolmafia_namespaceObject.putCloset)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject202 || (_templateObject202 = greyyou_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject203 || (_templateObject203 = greyyou_taggedTemplateLiteral(["soap knife"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject204 || (_templateObject204 = greyyou_taggedTemplateLiteral(["That's Not a Knife"])))),
    post: () => (0,external_kolmafia_namespaceObject.takeCloset)((0,external_kolmafia_namespaceObject.closetAmount)(template_string_$item(_templateObject205 || (_templateObject205 = greyyou_taggedTemplateLiteral(["soap knife"])))), template_string_$item(_templateObject206 || (_templateObject206 = greyyou_taggedTemplateLiteral(["soap knife"]))))
  }, {
    name: "Tip the Author",
    //disabled by default - must manually discover and enable the flag
    ready: () => args.tip,
    completed: () => !have(template_string_$item(_templateObject207 || (_templateObject207 = greyyou_taggedTemplateLiteral(["soap knife"])))),
