...
export function CommunityServiceTasks(): Quest[] {
  return [
    {
    ...
    // {
    //   name: "Community Service Ronin",
    //   completed: () =>
    //     getCurrentLeg() !== Leg.CommunityService || myPath() !== $path`Community Service` || myAdventures() <= 0,
    //   tasks: [
    //     {
    ...
    // },
    {
      name: "Post-CS Leveling",
      completed: () => getCurrentLeg() !== Leg.CommunityService || myLevel() >= args.targetlevel,
      tasks: [
        // {
        //   name: "Drink Pre-Tune",
        //   ready: () =>
    ...
    },
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          do: () => cliExecute(`Thanks for writing goorbo!`),
        },
        {
